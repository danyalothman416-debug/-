...
<head>
    ...
    <title>سیستەمی پێشکەوتووی قەرز و حسابات | پڕۆژەی دانیال</title>
    ...
    <style>
        ...
        * {
        ...
        /* مۆداڵەکان بە z-index ی زۆر بەرز تا بە هیچ جۆرێک بلۆک نەبن */
        .modal-screen {
            position: fixed;
            top: 0; left: 0; width: 100vw; height: 100vh;
...
<body>
    ...
    <div class="app-view" id="appView">
        <header class="navbar">
            ...
            <div style="display: flex; align-items: center; gap: 14px;">
                ...
                <!-- پرۆفایلی بەکارهێنەر لەگەڵ کلیک -->
                <div class="profile-btn-badge" id="profileBadgeBtn" onclick="openProfileModal()" title="کلیک بکە بۆ دەستکاریکردنی پرۆفایل">
    ...
    <div class="modal-screen" id="debtModal">
        <div class="modal-body">
            ...
            <form id="debtForm">
                ...
                <button type="submit" class="btn-action btn-gradient" style="width: 100%; justify-content: center; padding: 12px;">پاشەکەوتکردن</button>
            </form>
        </div>
    </div>

    <!-- مۆداڵی پرۆفایل و بایۆ و وێنە -->
    ...
    <script>
        ...
        // دڵنیابوونەوە لە داخستنی هەموو پەردە نەبینراوەکان لە کاتی دەستپێک
        let splashTimer = setTimeout(finishSplash, 2800);
        ...
        function finishSplash() {
            ...
            if (splash) {
                ...
                splash.style.pointerEvents = 'none'; // ڕێگەدەدات کلیکەکان تێپەڕن
                setTimeout(() => {
        ...
        function updateProfileUI() {
            ...
            document.getElementById('userBio').textContent = currentUser.bio || 'بێ بایۆ';
