...
# ================================
# 5. داتابەسی پشکنینەکانی تاقیگە (٢٠٠ پشکنین) - بە ناوی ئامێرەوە
# ================================
LAB_TESTS = {}
...
blood_tests = {
    ...
    "Platelets": {"گروپ": "خوێن", "نۆرماڵ": (150, 450), "یەکە": "x10³/µL", "تەفسیر": "پلەیتلێت", "ئامێر": "ئۆتۆماتیک سێل کاونتر (Sysmex XN-9000)"},
    "MCV": {"گروپ": "خوێن", "نۆرماڵ": (80, 100), "یەکە": "fL", "تەفسیر": "قەبارەی خڕۆکە سوورەکان", "ئامێر": "ئۆتۆماتیک سێل کاونتر (Sysmex XN-9000)"},
    "MCH": {"گروپ": "خوێن", "نۆرماڵ": (27, 33), "یەکە": "pg", "تەفسیر": "کەمی هیمۆگلۆبین", "ئامێر": "ئۆتۆماتیک سێل کاونتر (Sysmex XN-9000)"},
    "MCHC": {"گروپ": "خوێن", "نۆرماڵ": (32, 36), "یەکە": "g/dL", "تەفسیر": "چڕی هیمۆگلۆبین", "ئامێر": "ئۆتۆماتیک سێل کاونتر (Sysmex XN-9000)"},
    "RDW": {"گروپ": "خوێن", "نۆرماڵ": (11.5, 14.5), "یەکە": "%", "تەفسیر": "جیاوازی قەبارە", "ئامێر": "ئۆتۆماتیک سێل کاونتر (Sysmex XN-9000)"},
    "Reticulocyte": {"گروپ": "خوێن", "نۆرماڵ": (0.5, 2.5), "یەکە": "%", "تەفسیر": "خڕۆکە نوێکان", "ئامێر": "فلۆ سایتمیتەر (BD FACSCalibur)"},
    "Ferritin": {"گروپ": "خوێن", "نۆرماڵ": (15, 300), "یەکە": "ng/mL", "تەفسیر": "ئاسن", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "TIBC": {"گروپ": "خوێن", "نۆرماڵ": (250, 450), "یەکە": "mcg/dL", "تەفسیر": "ئاسن", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas c502)"},
    "Iron": {"گروپ": "خوێن", "نۆرماڵ": (60, 170), "یەکە": "mcg/dL", "تەفسیر": "ئاسن", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas c502)"},
    "Vitamin B12": {"گروپ": "خوێن", "نۆرماڵ": (200, 900), "یەکە": "pg/mL", "تەفسیر": "ڤیتامین B12", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Folate": {"گروپ": "خوێن", "نۆرماڵ": (3, 17), "یەکە": "ng/mL", "تەفسیر": "فۆلیک ئەسید", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "LDH": {"گروپ": "خوێن", "نۆرماڵ": (100, 250), "یەکە": "U/L", "تەفسیر": "ئەنزیم", "ئامێر": "سپێکترۆفۆتۆمیتەر (Beckman Coulter AU480)"},
    "Haptoglobin": {"گروپ": "خوێن", "نۆرماڵ": (50, 250), "یەکە": "mg/dL", "تەفسیر": "پروتێین", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)"},
    "ESR": {"گروپ": "خوێن", "نۆرماڵ": (0, 20), "یەکە": "mm/hr", "تەفسیر": "خێرایی تەنیشتن", "ئامێر": "ESR ئۆتۆماتیک (Ves-Matic 20)"},
    "CRP": {"گروپ": "خوێن", "نۆرماڵ": (0, 5), "یەکە": "mg/L", "تەفسیر": "پروتێینی هەوکردن", "ئامێر": "توربیدیمیتەر (Roche Cobas c502)"},
    "Procalcitonin": {"گروپ": "خوێن", "نۆرماڵ": (0, 0.5), "یەکە": "ng/mL", "تەفسیر": "هەوکردنی بەکتریایی", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Interleukin-6": {"گروپ": "خوێن", "نۆرماڵ": (0, 5), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)"},
    "TNF-alpha": {"گروپ": "خوێن", "نۆرماڵ": (0, 8), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)"},
}

# 5.2 پشکنینەکانی بایۆکیمیایی (٥٠ پشکنین)
biochem_tests = {
    "Glucose": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (70, 126), "یەکە": "mg/dL", "تەفسیر": "شەکری خوێن", "ئامێر": "گلوکۆمیتەر (Roche Cobas c502)"},
    "HbA1c": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (4.0, 5.6), "یەکە": "%", "تەفسیر": "شەکری درێژخایەن", "ئامێر": "HPLC (Bio-Rad D-100)"},
    "Creatinine": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (0.6, 1.3), "یەکە": "mg/dL", "تەفسیر": "کارایی گورچیلە", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "BUN": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (7, 20), "یەکە": "mg/dL", "تەفسیر": "نایترۆجینی یوریا", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "ALT": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (10, 40), "یەکە": "U/L", "تەفسیر": "ئەنزیمی جگەر", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "AST": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (10, 40), "یەکە": "U/L", "تەفسیر": "ئەنزیمی جگەر", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Bilirubin": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (0.1, 1.2), "یەکە": "mg/dL", "تەفسیر": "زەرداوی", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Albumin": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (3.5, 5.0), "یەکە": "g/dL", "تەفسیر": "ئەلبومین", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Potassium": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (3.5, 5.0), "یەکە": "mmol/L", "تەفسیر": "پۆتاسیۆم", "ئامێر": "ئایۆن سەلێکت یوڤ ئەنالایزەر (Roche Cobas c502)"},
    "Sodium": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (135, 145), "یەکە": "mmol/L", "تەفسیر": "سۆدیۆم", "ئامێر": "ئایۆن سەلێکت یوڤ ئەنالایزەر (Roche Cobas c502)"},
    "Calcium": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (8.5, 10.5), "یەکە": "mg/dL", "تەفسیر": "کالسیۆم", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Phosphorus": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (2.5, 4.5), "یەکە": "mg/dL", "تەفسیر": "فۆسفۆر", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Magnesium": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (1.7, 2.5), "یەکە": "mg/dL", "تەفسیر": "مەگنیسیۆم", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Amylase": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (20, 200), "یەکە": "U/L", "تەفسیر": "ئەنزیمی پەنکریاس", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Lipase": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (20, 200), "یەکە": "U/L", "تەفسیر": "ئەنزیمی پەنکریاس", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Cholesterol": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (0, 200), "یەکە": "mg/dL", "تەفسیر": "کۆلسترۆل", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "LDL": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (0, 100), "یەکە": "mg/dL", "تەفسیر": "کۆلسترۆلی خراپ", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "HDL": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (40, 60), "یەکە": "mg/dL", "تەفسیر": "کۆلسترۆلی باش", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Triglycerides": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (0, 150), "یەکە": "mg/dL", "تەفسیر": "تریگلیسیرید", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Total Protein": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (6.0, 8.0), "یەکە": "g/dL", "تەفسیر": "پڕۆتینی گشتی", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
}

# 5.3 پشکنینەکانی دڵ (٤٠ پشکنین)
cardiac_tests = {
    "Troponin I": {"گروپ": "دڵ", "نۆرماڵ": (0, 0.04), "یەکە": "ng/mL", "تەفسیر": "پروتێینی دڵ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Troponin T": {"گروپ": "دڵ", "نۆرماڵ": (0, 0.014), "یەکە": "ng/mL", "تەفسیر": "پروتێینی دڵ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "CK-MB": {"گروپ": "دڵ", "نۆرماڵ": (0, 5), "یەکە": "ng/mL", "تەفسیر": "ئەنزیمی دڵ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "BNP": {"گروپ": "دڵ", "نۆرماڵ": (0, 100), "یەکە": "pg/mL", "تەفسیر": "پروتێینی دڵ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Myoglobin": {"گروپ": "دڵ", "نۆرماڵ": (0, 80), "یەکە": "ng/mL", "تەفسیر": "پروتێین", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "HS-CRP": {"گروپ": "دڵ", "نۆرماڵ": (0, 2), "یەکە": "mg/L", "تەفسیر": "هەوکردنی دڵ", "ئامێر": "توربیدیمیتەر (Roche Cobas c502)"},
    "Homocysteine": {"گروپ": "دڵ", "نۆرماڵ": (5, 15), "یەکە": "μmol/L", "تەفسیر": "مەترسی دڵ", "ئامێر": "HPLC (Agilent 1200)"},
    "ApoB": {"گروپ": "دڵ", "نۆرماڵ": (60, 120), "یەکە": "mg/dL", "تەفسیر": "پرۆتێین", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)"},
    "ApoA": {"گروپ": "دڵ", "نۆرماڵ": (90, 150), "یەکە": "mg/dL", "تەفسیر": "پرۆتێین", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)"},
    "Lipoprotein(a)": {"گروپ": "دڵ", "نۆرماڵ": (0, 30), "یەکە": "mg/dL", "تەفسیر": "مەترسی دڵ", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)"},
}

# 5.4 پشکنینەکانی هەوکردن (٣٠ پشکنین)
inflammation_tests = {
    "Procalcitonin": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 0.5), "یەکە": "ng/mL", "تەفسیر": "هەوکردنی بەکتریایی", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "IL-6": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 5), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)"},
    "TNF-alpha": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 8), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)"},
    "Ferritin": {"گروپ": "هەوکردن", "نۆرماڵ": (15, 300), "یەکە": "ng/mL", "تەفسیر": "ئاسن", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "LDH": {"گروپ": "هەوکردن", "نۆرماڵ": (100, 250), "یەکە": "U/L", "تەفسیر": "ئەنزیم", "ئامێر": "سپێکترۆفۆتۆمیتەر (Beckman Coulter AU480)"},
    "Haptoglobin": {"گروپ": "هەوکردن", "نۆرماڵ": (50, 250), "یەکە": "mg/dL", "تەفسیر": "پروتێین", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)"},
}

# 5.5 پشکنینەکانی هۆرمۆن (٣٠ پشکنین)
hormone_tests = {
    "TSH": {"گروپ": "هۆرمۆن", "نۆرماڵ": (0.4, 4.0), "یەکە": "mIU/L", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "T4": {"گروپ": "هۆرمۆن", "نۆرماڵ": (5, 12), "یەکە": "μg/dL", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "T3": {"گروپ": "هۆرمۆن", "نۆرماڵ": (80, 200), "یەکە": "ng/dL", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Cortisol": {"گروپ": "هۆرمۆن", "نۆرماڵ": (5, 25), "یەکە": "μg/dL", "تەفسیر": "هۆرمۆنی پەستانی خوێن", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Insulin": {"گروپ": "هۆرمۆن", "نۆرماڵ": (2, 25), "یەکە": "μIU/mL", "تەفسیر": "هۆرمۆنی شەکر", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "C-peptide": {"گروپ": "هۆرمۆن", "نۆرماڵ": (0.5, 2.0), "یەکە": "ng/mL", "تەفسیر": "پێکهاتەی ئەنسولین", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "ACTH": {"گروپ": "هۆرمۆن", "نۆرماڵ": (10, 60), "یەکە": "pg/mL", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Growth Hormone": {"گروپ": "هۆرمۆن", "نۆرماڵ": (0, 5), "یەکە": "ng/mL", "تەفسیر": "هۆرمۆنی گەشە", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Prolactin": {"گروپ": "هۆرمۆن", "نۆرماڵ": (2, 15), "یەکە": "ng/mL", "تەفسیر": "هۆرمۆنی شیر", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Testosterone": {"گروپ": "هۆرمۆن", "نۆرماڵ": (300, 1000), "یەکە": "ng/dL", "تەفسیر": "هۆرمۆنی نێر", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Estradiol": {"گروپ": "هۆرمۆن", "نۆرماڵ": (20, 400), "یەکە": "pg/mL", "تەفسیر": "هۆرمۆنی مێ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
}

# 5.6 پشکنینەکانی میز (٣٠ پشکنین)
urine_tests = {
    "Urine Protein": {"گروپ": "میز", "نۆرماڵ": (0, 0.3), "یەکە": "g/24h", "تەفسیر": "پڕۆتینی میز", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Urine Glucose": {"گروپ": "میز", "نۆرماڵ": (0, 0), "یەکە": "mg/dL", "تەفسیر": "شەکری میز", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Urine Ketones": {"گروپ": "میز", "نۆرماڵ": (0, 0), "یەکە": "mg/dL", "تەفسیر": "کیتۆنی میز", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)"},
    "Urine WBC": {"گروپ": "میز", "نۆرماڵ": (0, 5), "یەکە": "/HPF", "تەفسیر": "خڕۆکە سپیەکان", "ئامێر": "مایکرۆسکۆپی (Olympus CX23)"},
    "Urine RBC": {"گروپ": "میز", "نۆرماڵ": (0, 3), "یەکە": "/HPF", "تەفسیر": "خڕۆکە سوورەکان", "ئامێر": "مایکرۆسکۆپی (Olympus CX23)"},
    "Urine pH": {"گروپ": "میز", "نۆرماڵ": (5.0, 8.0), "یەکە": "", "تەفسیر": "pH میز", "ئامێر": "pH میتر (Hanna HI221)"},
    "Urine Specific Gravity": {"گروپ": "میز", "نۆرماڵ": (1.005, 1.030), "یەکە": "", "تەفسیر": "چڕی میز", "ئامێر": "ریفڕاکتۆمیتەر (Atago PAL-10S)"},
}

# 5.7 پشکنینەکانی ڤیتامین (٢٠ پشکنین)
vitamin_tests = {
    "Vitamin D": {"گروپ": "ڤیتامین", "نۆرماڵ": (30, 100), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین D", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)"},
    "Vitamin A": {"گروپ": "ڤیتامین", "نۆرماڵ": (20, 80), "یەکە": "μg/dL", "تەفسیر": "ڤیتامین A", "ئامێر": "HPLC (Agilent 1200)"},
    "Vitamin E": {"گروپ": "ڤیتامین", "نۆرماڵ": (5, 18), "یەکە": "mg/L", "تەفسیر": "ڤیتامین E", "ئامێر": "HPLC (Agilent 1200)"},
    "Vitamin K": {"گروپ": "ڤیتامین", "نۆرماڵ": (0.2, 3.0), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین K", "ئامێر": "HPLC (Agilent 1200)"},
    "Vitamin C": {"گروپ": "ڤیتامین", "نۆرماڵ": (0.6, 2.0), "یەکە": "mg/dL", "تەفسیر": "ڤیتامین C", "ئامێر": "HPLC (Agilent 1200)"},
}

# 5.8 پشکنینەکانی معدن (٢٠ پشکنین)
mineral_tests = {
    "Zinc": {"گروپ": "معدن", "نۆرماڵ": (70, 120), "یەکە": "μg/dL", "تەفسیر": "زینک", "ئامێر": "ICP-MS (Agilent 7800)"},
    "Selenium": {"گروپ": "معدن", "نۆرماڵ": (70, 150), "یەکە": "μg/L", "تەفسیر": "سێلینیۆم", "ئامێر": "ICP-MS (Agilent 7800)"},
    "Copper": {"گروپ": "معدن", "نۆرماڵ": (70, 140), "یەکە": "μg/dL", "تەفسیر": "کۆپر", "ئامێر": "ICP-MS (Agilent 7800)"},
    "Manganese": {"گروپ": "معدن", "نۆرماڵ": (4, 15), "یەکە": "μg/L", "تەفسیر": "مەنگەنیز", "ئامێر": "ICP-MS (Agilent 7800)"},
    "Chromium": {"گروپ": "معدن", "نۆرماڵ": (0.5, 2.0), "یەکە": "μg/L", "تەفسیر": "کرۆمیۆم", "ئامێر": "ICP-MS (Agilent 7800)"},
}
...
# ================================
# 6. داتابەسی دەرمانەکان (١٢٠+ دەرمان) - بە وەسفی تەواو
# ================================
DRUG_DATABASE = {
    ...
    "دژە پەستانی خوێن": {
        ...
        "لۆسارتان": {"ڕێژە": "50-100mg", "میکانیزم": "ARB", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری گیرۆدەی ئەنجیۆتێنسین کە خوێنبەرەکان فراوان دەکات", "بۆچی": "بۆ چارەسەری پەستانی خوێن و پاراستنی گورچیلە"},
        "بایسۆپرۆلۆل": {"ڕێژە": "2.5-10mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "خاوکردنەوەی دڵ", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا کە لێدانی دڵ خاو دەکاتەوە", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵی ئیسکیمیک"},
        "هیدروکلۆرۆتایزید": {"ڕێژە": "12.5-25mg", "میکانیزم": "Thiazide diuretic", "کاریگەری لاوەکی": "نزمی پۆتاسیۆم", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی دەرکەری ئاو کە شلەمەنی زیاد لە جەستە دەر دەکات", "بۆچی": "بۆ کەمکردنەوەی پەستانی خوێن بە دەرکردنی نمەک و ئاو"},
        "فورۆسیماید": {"ڕێژە": "20-40mg", "میکانیزم": "Loop diuretic", "کاریگەری لاوەکی": "نزمی پۆتاسیۆم", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی دەرکەری بەهێز بۆ دەرکردنی ئاو و نمەک", "بۆچی": "بۆ چارەسەری پەستانی خوێن و ئاوسان لە نەخۆشی دڵ و گورچیلە"},
        "کارڤیدیلۆل": {"ڕێژە": "6.25-25mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا کە خوێنبەرەکان فراوان دەکات", "بۆچی": "بۆ نەخۆشی دڵی شکان و پەستانی خوێن"},
        "نایترۆگلیسیرین": {"ڕێژە": "0.3-0.6mg", "میکانیزم": "Nitrate", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نزمی BP", "وەسف": "دەرمانی فراوانکەری خوێنبەرەکان", "بۆچی": "بۆ چارەسەری ئازاری سنگ و نەخۆشی دڵی ئیسکیمیک"},
        "ئیسۆسۆرباید": {"ڕێژە": "10-30mg", "میکانیزم": "Nitrate", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نزمی BP", "وەسف": "دەرمانی نایترات بۆ فراوانکردنی خوێنبەرەکان", "بۆچی": "بۆ پێشگیری لە ئازاری سنگ"},
        "دیلتیازەم": {"ڕێژە": "30-60mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن و ئازاری سنگ"},
        "ڤێراپامیل": {"ڕێژە": "40-80mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "خاوکردنەوەی دڵ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم کە دڵ خاو دەکاتەوە", "بۆچی": "بۆ چارەسەری ئازاری سنگ و پەستانی خوێن"},
        "آتنۆلۆل": {"ڕێژە": "25-50mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "ماندوویی", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا بۆ کەمکردنەوەی کاری دڵ", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵ"},
        "میتۆپرۆلۆل": {"ڕێژە": "25-50mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "خاوکردنەوەی دڵ", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا بۆ دڵ و خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵی شکان"},
        "پروپانۆلۆل": {"ڕێژە": "10-40mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا بۆ کەمکردنەوەی دڵ", "بۆچی": "بۆ پەستانی خوێن، ئازاری سنگ، و خێرایی دڵ"},
        "رامبەریل": {"ڕێژە": "1.25-5mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ کەمکردنەوەی پەستانی خوێن", "بۆچی": "بۆ پاراستنی گورچیلە و کەمکردنەوەی پەستانی خوێن"},
        "کینیاپریل": {"ڕێژە": "5-20mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵ"},
        "تێلمیسارتان": {"ڕێژە": "40-80mg", "میکانیزم": "ARB", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری گیرۆدەی ئەنجیۆتێنسین", "بۆچی": "بۆ پەستانی خوێن و پاراستنی گورچیلە"},
        "ئیربێسارتان": {"ڕێژە": "150-300mg", "میکانیزم": "ARB", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "ARB بۆ کەمکردنەوەی پەستانی خوێن", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی گورچیلە"},
        "فۆزینۆپریل": {"ڕێژە": "10-40mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن"},
        "سپیرۆنۆلاکتۆن": {"ڕێژە": "25-50mg", "میکانیزم": "Aldosterone antagonist", "کاریگەری لاوەکی": "بەرزی پۆتاسیۆم", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دژە ئەلدۆستێرۆن بۆ دەرکردنی ئاو و نمەک", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵی شکان"}
    },
    # 6.2 دژە شەکرە (١٥ دەرمان)
    "دژە شەکرە": {
        "مێتفۆرمین": {"ڕێژە": "500-2000mg", "میکانیزم": "Biguanide", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی هێڵی یەکەم بۆ شەکرەی جۆری ٢ - کەمکردنی بەرهەمهێنانی شەکر لە جگەر و زیادکردنی هەستی ئەنسولین", "بۆچی": "بۆ کۆنتڕۆڵکردنی شەکری خوێن لە نەخۆشانی شەکرەی جۆری ٢"},
        "گلیپیزاید": {"ڕێژە": "5-20mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هەستیاری", "وەسف": "دەرمانی سەلفۆنیل یوریا کە پەنکریاس هان دەدات بۆ بەرهەمهێنانی زیاتری ئەنسولین", "بۆچی": "بۆ کەمکردنەوەی شەکری خوێن لە شەکرەی جۆری ٢"},
        "ئەنسولین Glargine": {"ڕێژە": "10-40 IU", "میکانیزم": "Insulin analog", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی درێژخایەن کە شەکر بە درێژایی ٢٤ کاتژمێر کۆنتڕۆڵ دەکات", "بۆچی": "بۆ کۆنتڕۆڵی شەکری خوێن لە شەکرەی جۆری ١ و جۆری ٢"},
        "سیتاگلیپتین": {"ڕێژە": "100mg", "میکانیزم": "DPP-4 inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "بەربەستەری DPP-4 کە ئاستی GLP-1 زیاد دەکات بۆ کەمکردنەوەی شەکر", "بۆچی": "بۆ کۆنتڕۆڵی شەکری خوێن لە شەکرەی جۆری ٢"},
        "ساکساگلیپتین": {"ڕێژە": "5mg", "میکانیزم": "DPP-4 inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "بەربەستەری DPP-4 بۆ کەمکردنەوەی شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢"},
        "لیناگلیپتین": {"ڕێژە": "5mg", "میکانیزم": "DPP-4 inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "بەربەستەری DPP-4 بۆ شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢"},
        "ئەلبیکوتاید": {"ڕێژە": "1-2mg", "میکانیزم": "GLP-1 agonist", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "هاندهری GLP-1 بۆ کەمکردنەوەی شەکر و کێش", "بۆچی": "بۆ شەکرەی جۆری ٢ و کەمکردنەوەی کێش"},
        "لیراگلوتاید": {"ڕێژە": "0.6-1.8mg", "میکانیزم": "GLP-1 agonist", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "هاندهری GLP-1 بۆ کۆنتڕۆڵی شەکر و کەمکردنەوەی کێش", "بۆچی": "بۆ شەکرەی جۆری ٢ و نەخۆشی دڵ"},
        "دولاگلوتاید": {"ڕێژە": "0.75-1.5mg", "میکانیزم": "GLP-1 agonist", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "هاندهری GLP-1 بۆ کۆنتڕۆڵی شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢"},
        "ئەنسولین Aspart": {"ڕێژە": "2-10 IU", "میکانیزم": "Insulin analog", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی خێرا بۆ کۆنتڕۆڵی شەکری پاش خواردن", "بۆچی": "بۆ شەکرەی جۆری ١ و جۆری ٢"},
        "ئەنسولین Lispro": {"ڕێژە": "2-10 IU", "میکانیزم": "Insulin analog", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی خێرا بۆ کۆنتڕۆڵی شەکر", "بۆچی": "بۆ شەکرەی جۆری ١ و جۆری ٢"},
        "ئەنسولین Regular": {"ڕێژە": "2-10 IU", "میکانیزم": "Insulin", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی ستاندارد بۆ کۆنتڕۆڵی شەکر", "بۆچی": "بۆ شەکرەی جۆری ١ و جۆری ٢"},
        "گلیمێپیراید": {"ڕێژە": "1-4mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هەستیاری", "وەسف": "سەلفۆنیل یوریا بۆ زیادی ئەنسولین", "بۆچی": "بۆ شەکرەی جۆری ٢"},
        "پایۆگلیتازۆن": {"ڕێژە": "15-45mg", "میکانیزم": "Thiazolidinedione", "کاریگەری لاوەکی": "ئاوسان", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "زیادکەری هەستی ئەنسولین لە شانەکاندا", "بۆچی": "بۆ شەکرەی جۆری ٢"},
        "ئەکاربۆز": {"ڕێژە": "25-50mg", "میکانیزم": "Alpha-glucosidase inhibitor", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گەدە", "وەسف": "بەربەستەری هەرسکردنی کاربۆهیدرات بۆ کەمکردنەوەی شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢"}
    },
    # 6.3 دژە کۆخە و هەوکردن (١٥ دەرمان)
    "دژە کۆخە و هەوکردن": {
        "ئەمۆکسیسیلین": {"ڕێژە": "500mg", "میکانیزم": "Beta-lactam", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "هەستیاری پێنیسیلین", "وەسف": "ئەنتیبایۆتیکی پێنیسیلین بۆ هەوکردنی بەکتریایی", "بۆچی": "بۆ هەوکردنی سییەکان، گەدە، میز"},
        "ئازیترۆمایسین": {"ڕێژە": "250-500mg", "میکانیزم": "Macrolide", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "ئەنتیبایۆتیکی ماکرۆلید بۆ هەوکردنی هەناسە", "بۆچی": "بۆ هەوکردنی سییەکان و کۆکە"},
        "سیپرۆفلۆکساسین": {"ڕێژە": "500mg", "میکانیزم": "Fluoroquinolone", "کاریگەری لاوەکی": "ئازاری ماسوولکە", "پێچەوانە": "منداڵان", "وەسف": "ئەنتیبایۆتیکی فلۆرۆکینۆلۆن بۆ هەوکردنی بەکتریایی", "بۆچی": "بۆ هەوکردنی میز و سییەکان"},
        "سێفتریاکسۆن": {"ڕێژە": "1-2g", "میکانیزم": "Cephalosporin", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "هەستیاری", "وەسف": "ئەنتیبایۆتیکی سێفالۆسپۆرین بۆ هەوکردنی توند", "بۆچی": "بۆ هەوکردنی سییەکان، گورچیلە، و خوێن"},
        "دۆکسیسایکلین": {"ڕێژە": "100mg", "میکانیزم": "Tetracycline", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "منداڵان", "وەسف": "ئەنتیبایۆتیکی تێتراسایکلین بۆ هەوکردنی جۆراوجۆر", "بۆچی": "بۆ هەوکردنی سییەکان، کۆلێرا، و سیل"},
        "تتراسایکلین": {"ڕێژە": "250-500mg", "میکانیزم": "Tetracycline", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "منداڵان", "وەسف": "ئەنتیبایۆتیکی تێتراسایکلین", "بۆچی": "بۆ هەوکردنی پێست و سییەکان"},
        "کوتریمۆکسازۆل": {"ڕێژە": "400-800mg", "میکانیزم": "Sulfonamide", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "هەستیاری", "وەسف": "ئەنتیبایۆتیکی سەلفۆنامید", "بۆچی": "بۆ هەوکردنی میز و سییەکان"},
        "مێترۆنیدازۆل": {"ڕێژە": "250-500mg", "میکانیزم": "Nitroimidazole", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "حەمل", "وەسف": "ئەنتیبایۆتیک بۆ بەکتریای ئانایروب", "بۆچی": "بۆ هەوکردنی گەدە و خوێن"},
        "فینوکسیمایسین": {"ڕێژە": "250mg", "میکانیزم": "Macrolide", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "ئەنتیبایۆتیکی ماکرۆلید", "بۆچی": "بۆ هەوکردنی هەناسە"},
        "سێفیکسیم": {"ڕێژە": "400mg", "میکانیزم": "Cephalosporin", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "هەستیاری", "وەسف": "سێفالۆسپۆرین بۆ هەوکردنی میز و سییەکان", "بۆچی": "بۆ هەوکردنی میز و کۆکە"},
        "لیفلوکسایسین": {"ڕێژە": "500mg", "میکانیزم": "Fluoroquinolone", "کاریگەری لاوەکی": "ئازاری ماسوولکە", "پێچەوانە": "منداڵان", "وەسف": "فلۆرۆکینۆلۆن بۆ هەوکردن", "بۆچی": "بۆ هەوکردنی سییەکان و میز"},
        "مۆکسیفلۆکساسین": {"ڕێژە": "400mg", "میکانیزم": "Fluoroquinolone", "کاریگەری لاوەکی": "ئازاری ماسوولکە", "پێچەوانە": "منداڵان", "وەسف": "فلۆرۆکینۆلۆن", "بۆچی": "بۆ هەوکردنی سییەکان"},
        "ریفامپیسین": {"ڕێژە": "600mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "زەردبوون", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل"},
        "ئایسۆنیازید": {"ڕێژە": "300mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "زیان بە جگەر", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل"},
        "پیرازیناماید": {"ڕێژە": "1500mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "ئازاری جومگە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل"}
    },
    # 6.4 دژە ئەنیمیا (١٠ دەرمان)
    "دژە ئەنیمیا": {
        "فێروس سولفەیت": {"ڕێژە": "300-600mg", "میکانیزم": "Iron supplement", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "هیمۆکروماتۆسیس", "وەسف": "پڕکەری ئاسن بۆ چارەسەری ئەنیمیای کەمخوێنی ئاسن", "بۆچی": "بۆ زیادی ئاسن لە جەستە و چارەسەری ئەنیمیا"},
        "فۆلیک ئەسید": {"ڕێژە": "1mg", "میکانیزم": "Folate supplement", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری فۆلیک ئەسید بۆ ئەنیمیای ماکرۆسایتیک", "بۆچی": "بۆ زیادکردنی فۆلیک ئەسید و چارەسەری ئەنیمیا"},
        "ڤیتامین B12": {"ڕێژە": "1000mcg", "میکانیزم": "Cobalamin", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری ڤیتامین B12 بۆ ئەنیمیای ماکرۆسایتیک", "بۆچی": "بۆ چارەسەری ئەنیمیای کەمخوێنی B12"},
        "ئەریترۆپۆیتین": {"ڕێژە": "50-100 IU/kg", "میکانیزم": "Erythropoietin", "کاریگەری لاوەکی": "BP بەرز", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "هۆرمۆنی دروستکردنی خڕۆکە سوورەکان", "بۆچی": "بۆ زیادکردنی خڕۆکە سوورەکان لە نەخۆشی گورچیلە"},
        "سیانۆکۆبالامین": {"ڕێژە": "1000mcg", "میکانیزم": "Vitamin B12", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری ڤیتامین B12", "بۆچی": "بۆ ئەنیمیای ماکرۆسایتیک"},
        "ئاسن دیکستران": {"ڕێژە": "100-200mg", "میکانیزم": "Iron supplement", "کاریگەری لاوەکی": "هەستیاری", "پێچەوانە": "هیمۆکروماتۆسیس", "وەسف": "پڕکەری ئاسن بۆ نەخۆشانی گورچیلە", "بۆچی": "بۆ چارەسەری ئەنیمیای کەمخوێنی ئاسن"},
        "دێسفێریۆکسامین": {"ڕێژە": "500-1000mg", "میکانیزم": "Iron chelator", "کاریگەری لاوەکی": "زیان بە گورچیلە", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی دەرکردنی ئاسنی زۆر لە جەستە", "بۆچی": "بۆ چارەسەری هیمۆکروماتۆسیس"},
        "فۆلیک اسید": {"ڕێژە": "1-5mg", "میکانیزم": "Folate", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری فۆلیک ئەسید", "بۆچی": "بۆ ئەنیمیای ماکرۆسایتیک"},
        "دەیکسۆمیتازۆن": {"ڕێژە": "0.5-2mg", "میکانیزم": "Steroid", "کاریگەری لاوەکی": "کێش زیادکردن", "پێچەوانە": "هەوکردن", "وەسف": "ستیرۆید بۆ هەوکردن و ئەنیمیا", "بۆچی": "بۆ چارەسەری ئەنیمیای هیمۆلایتیک"},
        "پرەدنیسۆلۆن": {"ڕێژە": "5-20mg", "میکانیزم": "Steroid", "کاریگەری لاوەکی": "کێش زیادکردن", "پێچەوانە": "هەوکردن", "وەسف": "ستیرۆید بۆ هەوکردن و خۆئەگەری", "بۆچی": "بۆ ئەنیمیای هیمۆلایتیک"}
    },
    # 6.5 دژە کۆکە (١٠ دەرمان)
    "دژە کۆکە": {
        "سالبوتامۆل": {"ڕێژە": "2 puffs", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە بۆ کۆکە", "بۆچی": "بۆ چارەسەری کۆکە و COPD"},
        "بۆدیزۆناید": {"ڕێژە": "200-800mcg", "میکانیزم": "Steroid inhaler", "کاریگەری لاوەکی": "هەوکردنی دەم", "پێچەوانە": "هەستیاری", "وەسف": "ستیرۆیدی هەناسەدان بۆ کەمکردنەوەی هەوکردن", "بۆچی": "بۆ پێشگیری لە کۆکە"},
        "فۆرمۆتێرۆل": {"ڕێژە": "6-12mcg", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە و COPD"},
        "فلوتیکاسۆن": {"ڕێژە": "250-500mcg", "میکانیزم": "Steroid inhaler", "کاریگەری لاوەکی": "هەوکردنی دەم", "پێچەوانە": "هەستیاری", "وەسف": "ستیرۆیدی هەناسەدان", "بۆچی": "بۆ کۆکە"},
        "مۆنتلۆکاست": {"ڕێژە": "10mg", "میکانیزم": "Leukotriene inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "هەستیاری", "وەسف": "بەربەستەری لیوکۆترین بۆ کەمکردنەوەی هەوکردن", "بۆچی": "بۆ کۆکە و هەستێکی هەوە"},
        "زافیرلوکاست": {"ڕێژە": "20mg", "میکانیزم": "Leukotriene inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "هەستیاری", "وەسف": "بەربەستەری لیوکۆترین", "بۆچی": "بۆ کۆکە"},
        "تیۆترۆپیۆم": {"ڕێژە": "18mcg", "میکانیزم": "Anticholinergic", "کاریگەری لاوەکی": "دەم وشک", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری ئەستیلکۆلین بۆ فراوانکردنی بۆڕی هەناسە", "بۆچی": "بۆ COPD و کۆکە"},
        "ئیپرەترۆپیۆم": {"ڕێژە": "20mcg", "میکانیزم": "Anticholinergic", "کاریگەری لاوەکی": "دەم وشک", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری ئەستیلکۆلین", "بۆچی": "بۆ COPD"},
        "تئۆفیلین": {"ڕێژە": "100-200mg", "میکانیزم": "Bronchodilator", "کاریگەری لاوەکی": "خێرالێدانی دڵ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە و COPD"},
        "ئامینۆفیلین": {"ڕێژە": "100-200mg", "میکانیزم": "Bronchodilator", "کاریگەری لاوەکی": "خێرالێدانی دڵ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە"}
    },
    # 6.6 دژە سکچوون (١٠ دەرمان)
    "دژە سکچوون": {
        "ئومەپرازۆل": {"ڕێژە": "20-40mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن بۆ کەمکردنەوەی ترشێتی گەدە", "بۆچی": "بۆ چارەسەری سکچوون و برینداری گەدە"},
        "لانسۆپرازۆل": {"ڕێژە": "30mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ سکچوون"},
        "پانتۆپرازۆل": {"ڕێژە": "40mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ گەدە و سکچوون"},
        "ڕابێپرازۆل": {"ڕێژە": "20mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "PPI بۆ کەمکردنەوەی ترشێتی", "بۆچی": "بۆ سکچوون"},
        "ڕانیتیدین": {"ڕێژە": "150mg", "میکانیزم": "H2 blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری H2 بۆ کەمکردنەوەی ترشێتی", "بۆچی": "بۆ سکچوون"},
        "فامۆتیدین": {"ڕێژە": "20-40mg", "میکانیزم": "H2 blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری H2", "بۆچی": "بۆ سکچوون"},
        "سوکرالفەیت": {"ڕێژە": "1g", "میکانیزم": "Mucosal protectant", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "پارێزەری پەردەی گەدە", "بۆچی": "بۆ برینداری گەدە"},
        "بسمەت سابیسیلیت": {"ڕێژە": "262mg", "میکانیزم": "Antidiarrheal", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "منداڵان", "وەسف": "دژە سکچوون بۆ کەمکردنەوەی سکچوون", "بۆچی": "بۆ سکچوون و گەدە"},
        "میزۆپرۆستۆل": {"ڕێژە": "100-200mcg", "میکانیزم": "Prostaglandin", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "حەمل", "وەسف": "پرۆستاگلاندین بۆ پاراستنی گەدە", "بۆچی": "بۆ پێشگیری لە برینداری گەدە لە NSAIDs"},
        "سوکرالفەیت": {"ڕێژە": "1g", "میکانیزم": "Mucosal protectant", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "پارێزەری گەدە", "بۆچی": "بۆ برینداری گەدە"}
    },
    # 6.7 دژە ئازار (١٠ دەرمان)
    "دژە ئازار": {
        "ئەسپیرین": {"ڕێژە": "75-300mg", "میکانیزم": "NSAID", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە ئازار و دژە تەمەن بۆ کەمکردنەوەی ئازار و تا", "بۆچی": "بۆ ئازاری کەم و ناوەند و پێشگیری لە خوێن مەبەست"},
        "ئیبۆپروفین": {"ڕێژە": "200-400mg", "میکانیزم": "NSAID", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دژە ئازار و دژە هەوکردن", "بۆچی": "بۆ ئازاری ماسوولکە و سەرئێشە"},
        "نابومیتۆن": {"ڕێژە": "500mg", "میکانیزم": "NSAID", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دژە هەوکردن بۆ ئازاری جومگەکان", "بۆچی": "بۆ ئازاری جومگە و ئارتریت"},
        "پاراستامۆل": {"ڕێژە": "500-1000mg", "میکانیزم": "Analgesic", "کاریگەری لاوەکی": "زیان بە جگەر", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "دژە ئازار و دژە تەمەن بۆ هەموو ئازارەکان", "بۆچی": "بۆ ئازاری سەرئێشە و تا"},
        "مۆرفین": {"ڕێژە": "5-10mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی هەناسە", "وەسف": "دژە ئازاری بەهێز بۆ ئازاری توند", "بۆچی": "بۆ ئازاری توند وەک ئازاری شێرپەنجە"},
        "کۆدەین": {"ڕێژە": "30mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "منداڵان", "وەسف": "دژە ئازاری مامناوەند", "بۆچی": "بۆ ئازاری مامناوەند"},
        "ترامادۆل": {"ڕێژە": "50mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە ئازاری نا ئۆپیۆیدی", "بۆچی": "بۆ ئازاری مامناوەند"},
        "پێتیدین": {"ڕێژە": "50mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە ئازاری بەهێز", "بۆچی": "بۆ ئازاری توند"},
        "ناکسۆکسان": {"ڕێژە": "5-10mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە ئازار", "بۆچی": "بۆ ئازاری ناوەند"},
        "فوێنتانیل": {"ڕێژە": "25mcg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی هەناسە", "وەسف": "دژە ئازاری زۆر بەهێز", "بۆچی": "بۆ ئازاری شێرپەنجە"}
    },
    # 6.8 دژە خوێن (١٠ دەرمان)
    "دژە خوێن": {
        "وارفارین": {"ڕێژە": "5mg", "میکانیزم": "Vitamin K antagonist", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "حەمل", "وەسف": "دژە خوێن بۆ پێشگیری لە مەبەست", "بۆچی": "بۆ پێشگیری لە خوێن مەبەست"},
        "هێپارین": {"ڕێژە": "5000 IU", "میکانیزم": "Anticoagulant", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە خوێنی خێرا بۆ نەخۆشخانە", "بۆچی": "بۆ پێشگیری لە مەبەست"},
        "ئەنۆکساپارین": {"ڕێژە": "40mg", "میکانیزم": "LMWH", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە خوێنی کەم کێش", "بۆچی": "بۆ پێشگیری لە مەبەست"},
        "کلۆپیدۆگرێل": {"ڕێژە": "75mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت بۆ پێشگیری لە مەبەست", "بۆچی": "بۆ نەخۆشی دڵی ئیسکیمیک"},
        "پراسوگرێل": {"ڕێژە": "10mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ ئازاری سنگ"},
        "تیکاگرێلۆر": {"ڕێژە": "90mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ نەخۆشی دڵ"},
        "دابیگاتران": {"ڕێژە": "110mg", "میکانیزم": "Direct thrombin inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری ترۆمبین", "بۆچی": "بۆ پێشگیری لە مەبەست"},
        "ریڤارۆکسابان": {"ڕێژە": "10mg", "میکانیزم": "Factor Xa inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری فاکتۆر Xa", "بۆچی": "بۆ مەبەست"},
        "ئەپیکسابان": {"ڕێژە": "2.5-5mg", "میکانیزم": "Factor Xa inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری فاکتۆر Xa", "بۆچی": "بۆ مەبەست"},
        "ئیدۆکسابان": {"ڕێژە": "30-60mg", "میکانیزم": "Factor Xa inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری فاکتۆر Xa", "بۆچی": "بۆ مەبەست"}
    }
}
...
# ================================
# 15. پەڕەی تاقیگە (٢٠٠ پشکنین) - پشکنینەکان بە ناوی ئامێر و رێژەی نائاسایی
# ================================
...
# ================================
# 17. پەڕەی فارماکۆلۆجی - بە وەسفی تەواو
# ================================
