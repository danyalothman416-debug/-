...
# ================================
# 5. داتابەسی پشکنینەکانی تاقیگە (٣٠٠ پشکنین)
# ================================
LAB_TESTS = {}

# 5.1 پشکنینەکانی خوێن
blood_tests = {
...
# ================================
# 6. داتابەسی دەرمانەکان (٣٠٠+ دەرمان)
# ================================
DRUG_DATABASE = {}

# 6.1 دژە پەستانی خوێن
anti_hypertensives = {
...
# ================================
    ...
    <div class="main">
        ...
        <p style="color:#aaa;">٣٠٠+ پشکنینی تاقیگە لەگەڵ ئامێرەکان</p>
    </div>
    """, unsafe_allow_html=True)
...
# ================================
# 16. پەڕەی فارماکۆلۆجی
# ================================
elif page == "💊 فارماکۆلۆجی":
    st.markdown("""
    <div class="main">
        <h2>💊 فارماکۆلۆجی و دەرمانناسی - Dr.Danyal</h2>
        <p style="color:#aaa;">٣٠٠+ دەرمان لەگەڵ وەسف</p>
    </div>
    """, unsafe_allow_html=True)
...
# ================================
# 18. پەڕەی پێشکەوتن و دەستکەوتەکان
# ================================
