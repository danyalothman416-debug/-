...
with st.container():
    ...
    with c_logo:
        L = languages[lang_choice]
        st.markdown(f"<h2 style='color:#D4AF37; margin:0; font-family:sans-serif;'>{L['title']}</h2>", unsafe_allow_html=True)
...
# TERMS PAGE (The new separate section)
