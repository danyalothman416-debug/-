...
st.markdown("""
    ...
    .num-fix { direction: ltr !important; display: inline-block !important; color: #D4AF37; }
    </style>
...
st.markdown("""
    <div class="brand-header">
        ...
        <div style="color:white;">گۆڵدن دێلیڤەری: خێراترین گەیاندن لە کەرکوک</div>
    </div>
""", unsafe_allow_html=True)
...
# نیشاندانی ژمارەکان
st.markdown(f'<div style="text-align:center; padding:20px;">📞 <span class="num-fix">0772 195 9922</span></div>', unsafe_allow_html=True)

# --- بارەکەی خوارەوە (ئەمە ئەو بەشەیە کە داوات کردبوو) ---
st.markdown("""
    <div class="install-bar">
        <span>بۆ دابەزاندنی ئەپەکە: کلیک لە <span class="install-icon">⎙</span> یان <span class="install-icon">⋮</span> بکە و <b>Add to Home Screen</b> هەڵبژێرە</span>
    </div>
