...
# فۆرمی تۆمارکردنی داواکاری (لەسەرەوە)
...
# بەشی ڕێنمایی دابەزاندن (ئێستا لە خوارەوەیە)
with st.expander("📲 چۆن ئەپەکە دابەزێنم بۆ سەر شاشە؟"):
    st.markdown("""
    <div style="text-align:right; font-size:14px; color:#555;">
    بۆ ئەوەی هەمیشە وەک بەرنامە لەبەردەستت بێت:<br>
    ١. کلیک لە نیشانەی <b>Share (📤)</b> بکە لە خوارەوە.<br>
    ٢. بگەڕێ بۆ <b>Add to Home Screen</b> و کلیکی لێ بکە.<br>
    ٣. لە کۆتاییدا کلیک لە <b>Add</b> بکە.
    </div>
    """, unsafe_allow_html=True)
...
if query_params.get("role") == "boss":
    st.write("---")
    with st.expander("🛠 بەشی کارگێڕی (Admin Area)"):
    ...
    st.markdown('<div style="text-align:center; opacity:0.2; font-size:10px; padding-bottom:60px;">Golden Delivery v1.2</div>', unsafe_allow_html=True)
