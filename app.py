...
languages = {
    "کوردی 🇭🇺": {
        ...
        "location_label": "📍 لینکی نەخشە (ئۆتۆماتیکی)", "price": "💰 نرخ (د.ع)",
        ...
        "admin_title": "🛠 پانێڵی بەڕێوەبەرایەتی", "admin_pass": "پاسۆرد",
    ...
    "العربية 🇮🇶": {
        ...
        "admin_title": "🛠 لوحة التحكم", "admin_pass": "كلمة المرور",
...
# هەڵبژاردنی زمان
c_ref, c_lang, c_empty = st.columns([0.5, 1.5, 4])
with c_ref:
...
# --- جی پی ئێس (GPS) ئۆتۆماتیکی ---
# ئەمە وا دەکات هەر کە سایتەکە کرایەوە داوای GPS بکات
...
if loc:
    ...
    st.toast(L['gps_success'])
else:
    st.caption(L['get_gps'])
...
with st.form("delivery_form", clear_on_submit=True):
    ...
    with col2:
        ...
        # ئۆتۆماتیکی لینکی نەخشەکە لێرە دادەنرێت
...
# --- 🛠 پانێڵی بەڕێوەبەر (تەنها بە لینک دەردەکەوێت) ---
