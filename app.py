...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ١. دەستپێکی هێمنی "دانیال" بە شێوازی فەرمیی ئەپڵ */
        #splashScreen {
            position: fixed;
...
<body>
    ...
    <!-- ١. دەستپێکی هێمنی ئەپڵ بە ناوی "دانیال" -->
    <div id="splashScreen">
    ...
    <!-- ٢. پەڕەی چوونەژوورەوە بە ناوی بەکارهێنەر و وشەی نهێنی -->
    <div class="auth-container" id="authSection">
        <div class="auth-card">
            <div style="text-align: center; margin-bottom: 24px;">
                ...
                <p style="font-size: 12px; color: var(--ios-muted);">ناوی بەکارهێنەر و وشەی نهێنی بنووسە</p>
            </div>

            <form id="authForm" onsubmit="event.preventDefault(); submitAuth();">
                <div class="form-group">
                    <label>ناوی بەکارهێنەر (Username)</label>
                    <input type="text" id="userInput" required placeholder="danyal" autocomplete="username">
                </div>
                <div class="form-group">
                    <label>وشەی نهێنی (Password)</label>
                    <input type="password" id="passInput" required placeholder="••••••••" autocomplete="current-password">
                </div>
    ...
    <div class="ios-modal" id="profileModal">
        <div class="ios-sheet">
            ...
            <form id="profileForm" onsubmit="event.preventDefault(); saveProfile();">
                ...
                <div class="form-group">
                    <label>ناوی فرۆشگا / دوکان</label>
                    <input type="text" id="profileShopName">
                </div>
                <div class="form-group">
                    <label>بایۆ</label>
    ...
    <script>
        ...
        // ئەنیمەیشنی هێمن بە شێوازی فەرمیی ئەپڵ
        ...
        async function checkAuth() {
            try {
                ...
                if (data.logged_in) {
                    ...
                    document.getElementById('topBizName').textContent = data.user.shop_name || 'فرۆشگای دانیال';
                    ...
                    document.getElementById('profileShopName').value = data.user.shop_name || '';
        ...
        // چوونەژوورەوە بە ناوی بەکارهێنەر و وشەی نهێنی
        async function submitAuth() {
            ...
            try {
                ...
                errMsg.textContent = "سێرڤەرەکە کارناکات یان پەیوەندی پچڕاوە";
                errMsg.style.display = 'block';
            } finally {
        ...
        async function saveProfile() {
            ...
            formData.append('shop_name', document.getElementById('profileShopName').value.trim());
