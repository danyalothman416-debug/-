...
DESIGN_SYSTEM = """
<style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Outfit:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600&display=swap');
    ...
    * { font-family: 'Inter', 'Outfit', sans-serif; }
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #0a0a1a, #12122e, #0a0a1a) !important;
    ...
    @media (max-width: 768px) {
        ...
        .premium-card { padding: 1.2rem !important; }
    }
</style>
"""
...
TRANSLATIONS = {
    "en": {
        ...
        "drugs_count": "Medications",
        "tests_count": "Lab Tests",
        ...
        "select_minimum": "Select 2 or more medications",
        ...
        "drugs_selected": "medications selected",
    },
    "ku": {
        ...
        "password": "وشەی نهێنی",
        "confirm_password": "دووپاتکردنەوە",
        "login_button": "چوونەژوورەوە",
        "register_button": "دروستکردن",
        "logout": "چوونەدەرەوە",
        "enter_username": "ناوی بەکارهێنەر بنووسە",
        "enter_password": "وشەی نهێنی بنووسە",
        "confirm_password_placeholder": "دووپات بکەرەوە",
        ...
        "quiz": "کویز",
        "comprehensive_exam": "تاقیکردنەوە",
        "spaced_repetition": "دووبارەکردنەوە",
        "lab_tests": "تاقیگە",
        "pharmacology": "فارماکۆلۆجی",
        "drug_interactions": "کارلێکی دەرمان",
        "leaderboard": "ڕێزلێنان",
        ...
        "cases": "کەیس",
        "level": "ئاست",
        "level_progress": "پێشکەوتن",
        "diseases_count": "نەخۆشی",
        "drugs_count": "دەرمان",
        "tests_count": "پشکنین",
        "total_users": "بەکارهێنەر",
        "your_progress": "پێشکەوتنەکەت",
        "platform_stats": "ئامارەکان",
        "accuracy": "ڕێژەی ڕاستی",
        "cases_solved": "کەیسەکان",
        "disease_library": "کتێبخانە",
        "search": "گەڕان",
        ...
        "risk": "مەترسی",
        "category": "پۆلێن",
        "clinical_case_analysis": "شیکاری کەیس",
        "generate_new_case": "کەیسی نوێ",
        "your_diagnosis": "دەستنیشانکردن",
        "submit": "ناردن",
        "correct": "ڕاستە!",
        "incorrect": "هەڵەیە.",
        "patient": "نەخۆش",
        ...
        "select_answer": "وەڵام هەڵبژێرە",
        "submit_answer": "ناردن",
        "comprehensive_exam_title": "تاقیکردنەوە",
        "start_exam": "دەستپێکردن",
        "submit_exam": "ناردن",
        "score": "نمرە",
        "retake": "دووبارە",
        "spaced_repetition_title": "دووبارەکردنەوە",
        "reveal_answer": "ئاشکراکردن",
        "knew_it": "زانیم",
        "review_again": "دووبارە",
        "lab_tests_title": "پشکنینەکان",
        "normal_range": "مەودای ئاسایی",
        "description": "وەسف",
        "no_tests_found": "نەدۆزرایەوە",
        "pharmacology_title": "دەرمانەکان",
        "drug_class": "پۆلێن",
        "dose": "ڕێژە",
        "indications": "بەکارهێنان",
        "side_effects": "کاریگەری لاوەکی",
        "drug_interactions_title": "کارلێکی دەرمان",
        "select_drugs": "دەرمان هەڵبژێرە",
        "select_minimum": "٢ دەرمان یان زیاتر",
        "leaderboard_title": "ڕێزلێنان",
        "no_data": "داتا نییە",
        "ai_assistant_title": "یاریدەدەری زیرەک",
        "enter_symptoms": "نیشانەکان بنووسە:",
        "analyze": "شیکردنەوە",
        "match": "گونجان",
        "results": "ئەنجامەکان",
        "clinical_notes_title": "تێبینییەکان",
        "patient_info": "زانیاری نەخۆش",
        "clinical_note": "تێبینی",
        "save_note": "خەزنکردن",
        "note_saved": "خەزن کرا!",
        "achievements_title": "دەستکەوتەکان",
        "earned": "بەدەستهێنراوە",
        "locked": "داخراوە",
        "account_created": "هەژمار دروست کرا!",
        "invalid_credentials": "زانیاری هەڵە",
        "username_exists": "ناو پێشتر هەیە",
        "passwords_dont_match": "وشەکان یەک ناگرن",
        "what_are_symptoms_of": "نیشانەکانی",
    ...
    "ar": {
        ...
        "spaced_repetition": "تكرار متباعد",
        "lab_tests": "المختبر",
        "pharmacology": "الأدوية",
        "drug_interactions": "تداخلات دوائية",
        "leaderboard": "المتصدرون",
        "medical_news": "أخبار طبية",
        "ai_assistant": "مساعد ذكي",
        "clinical_notes": "ملاحظات",
        ...
        "total_users": "مستخدم",
        "your_progress": "تقدمك",
        "platform_stats": "إحصائيات",
        "accuracy": "دقة",
        "cases_solved": "حالات محلولة",
        ...
        "risk": "خطورة",
        "category": "فئة",
        "clinical_case_analysis": "تحليل حالة",
        "generate_new_case": "حالة جديدة",
        ...
        "submit_answer": "إرسال",
        "comprehensive_exam_title": "امتحان شامل",
        "start_exam": "ابدأ",
        "submit_exam": "تسليم",
        "score": "نتيجة",
        "retake": "إعادة",
        "spaced_repetition_title": "تكرار متباعد",
        "reveal_answer": "كشف",
        "knew_it": "أعرفها",
        "review_again": "مراجعة",
        "lab_tests_title": "تحاليل",
        "normal_range": "المدى الطبيعي",
        "description": "وصف",
        "no_tests_found": "لا توجد نتائج",
        "pharmacology_title": "أدوية",
        "drug_class": "فئة",
        "dose": "جرعة",
        "indications": "دواعي",
        "side_effects": "آثار جانبية",
        "drug_interactions_title": "تداخلات",
        "select_drugs": "اختر أدوية",
        "select_minimum": "دواءين أو أكثر",
        "leaderboard_title": "المتصدرون",
        "no_data": "لا بيانات",
        "ai_assistant_title": "مدقق أعراض",
        "enter_symptoms": "أدخل الأعراض:",
        "analyze": "تحليل",
        "match": "تطابق",
        "results": "نتائج",
        "clinical_notes_title": "ملاحظات",
        "patient_info": "معلومات",
        "clinical_note": "ملاحظة",
        "save_note": "حفظ",
        "note_saved": "تم الحفظ!",
        "achievements_title": "إنجازات",
        "earned": "مكتسب",
        "locked": "مقفل",
        "account_created": "تم الإنشاء!",
        "invalid_credentials": "بيانات خاطئة",
        "username_exists": "الاسم موجود",
        "passwords_dont_match": "كلمات غير متطابقة",
        "what_are_symptoms_of": "أعراض",
        "is_characteristic_of": "مميز لـ",
        "answer_was": "الإجابة",
        "drugs_selected": "دواء مختار",
    }
}
...
for i in range(90):
    q_type = random.choice(["symptom","class","normal"])
    if q_type=="symptom":
...
# ╚══════════════════════════════════════════════════════════════════════════════╝
def iss():
    for k,v in {'logged_in':False,'username':"",'xp':0,'qs':0,'tc':0,'cd':0,'streak':0,'page':"Dashboard",'ff':False,'ce':None,'ca':{},'cs':False,'csc':0,'case':None,'ach':[],'lang':'en'}.items():
...
if not st.session_state.logged_in:
    ...
    with cc:
        ...
        <div style="text-align:center;padding:2rem 0;">
            ...
            <p style="color:var(--text-secondary);font-size:1.1rem;letter-spacing:0.5px;">{t('app_subtitle',lg)}</p>
        </div>
        """,True)
...
with st.sidebar:
    ...
    <div class="premium-card" style="text-align:center;padding:1.5rem;">
        ...
        <div style="font-weight:700;color:var(--text-primary);font-size:1.1rem;margin:0.5rem 0;">{st.session_state.username}</div>
        <span class="badge badge-primary">{li[0]}</span>
        <div style="margin-top:1rem;">
            <div class="progress-bar"><div class="progress-fill" style="width:{pg:.1f}%;"></div></div>
            <div style="font-size:0.65rem;color:var(--text-muted);text-align:right;margin-top:0.3rem;">{t('level_progress',lg)} {pg:.0f}%</div>
        </div>
    </div>
    ...
    # Navigation
    pages=[("dashboard","📊 Dashboard"),("diseases","🦠 Diseases"),("case_analysis","🔬 Case Analysis"),
           ("quiz","🧠 Quiz"),("comprehensive_exam","📋 Exam"),("spaced_repetition","🔄 Review"),
           ("lab_tests","🧪 Lab"),("pharmacology","💊 Drugs"),("drug_interactions","⚠️ Interactions"),
           ("leaderboard","🏆 Rankings"),("medical_news","📰 News"),("ai_assistant","🤖 AI"),
           ("clinical_notes","📝 Notes"),("achievements","🎯 Badges")]
    for k,pn in pages:
        if st.button(pn,use_container_width=True,key=f"nav_{k}"):
            st.session_state.page=k;st.rerun()
    
    st.markdown("---")
    if st.button(f"🚪 {t('logout',lg)}",use_container_width=True): st.session_state.logged_in=False;st.rerun()
    st.markdown(f'<div style="text-align:center;font-size:0.65rem;color:var(--text-muted);"><span class="badge badge-primary">{t("version",lg)}</span></div>',True)
...
if pg=="Dashboard":
    ...
    if st.session_state.ff:
        st.markdown(f'<div class="premium-card" style="text-align:center;"><h3>{d}</h3><p><strong>{t("symptoms",lg)}:</strong> {", ".join(gs(inf,lg)[:4])}</p><p style="color:var(--primary-light);"><strong>{t("treatment",lg)}:</strong> {", ".join(gt(inf,lg)[:3])}</p></div>',True)
        c1,c2=st.columns(2)
        with c1:
...
elif pg=="Medical News":
    st.markdown(f'<h2>📰 {t("medical_news",lg)} ({len(MEDICAL_NEWS)})</h2>',True)
    for n in MEDICAL_NEWS[:20]:
        st.markdown(f'<div class="premium-card"><h4>📰 {n["t"]}</h4><p>{n["s"]}</p><p style="color:var(--text-muted);">📅 {n["d"]} | 📚 {n["src"]}</p></div>',True)

elif pg=="AI Assistant":
    st.markdown(f'<h2>🤖 {t("ai_assistant_title",lg)}</h2>',True)
    st.markdown(f'<p style="color:var(--text-secondary);">📊 {len(DISEASE_DATABASE)} diseases | {sum(len(d) for d in DRUG_DATABASE.values())} drugs | {len(LAB_TESTS)} tests loaded</p>',True)
    ...
    for n in get_db().execute("SELECT * FROM clinical_notes WHERE username=? ORDER BY created_at DESC LIMIT 20",(st.session_state.username,)).fetchall():
        st.markdown(f'<div class="premium-card"><p><strong>{t("patient_info",lg)}:</strong> {n["patient_info"]}</p><p>{n["note"]}</p><p style="color:var(--text-muted);">{n["created_at"][:10]}</p></div>',True)
...
<div style="text-align:center;padding:2rem;color:var(--text-muted);">
    <p style="font-weight:600;color:var(--text-secondary);">⚕️ Dr.Danyal Medical Platform {t('version',lg)}</p>
