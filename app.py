...
def create_user(username: str, password: str) -> bool:
    ...
    users[username] = {
        ...
        "custom_lab_tests": {},
        "custom_drugs": {},
        "clinical_notes": []  # بۆ خەزنکردنی نۆتەکانی کلینیکی
    }
    save_users(users)
    return True
...
def add_clinical_note(username: str, note_text: str):
    """زیادکردنی نۆتی کلینیکی نوێ"""
    users = load_users()
    if username in users:
        if "clinical_notes" not in users[username]:
            users[username]["clinical_notes"] = []
        users[username]["clinical_notes"].append({
            "note": note_text,
...
# ================================
# 5. داتابەسی پشکنینەکانی تاقیگە (٣٠٠ پشکنین) - بە ناوی ئامێر و تێبینی
# ================================
LAB_TESTS = {}

# 5.1 پشکنینەکانی خوێن (٧٥ پشکنین)
blood_tests = {
    ...
    "WBC Differential": {"گروپ": "خوێن", "نۆرماڵ": (1.0, 4.0), "یەکە": "x10³/µL", "تەفسیر": "جیاکردنەوەی خڕۆکە سپیەکان", "ئامێر": "فلۆ سایتمیتەر (Sysmex XN-9000)", "تێبینی": ""},
    "Neutrophils": {"گروپ": "خوێن", "نۆرماڵ": (2.0, 7.0), "یەکە": "x10³/µL", "تەفسیر": "خڕۆکە بێهۆشکەرەکان", "ئامێر": "فلۆ سایتمیتەر (Sysmex XN-9000)", "تێبینی": ""},
    "Lymphocytes": {"گروپ": "خوێن", "نۆرماڵ": (1.0, 4.0), "یەکە": "x10³/µL", "تەفسیر": "خڕۆکە لیمفۆییەکان", "ئامێر": "فلۆ سایتمیتەر (Sysmex XN-9000)", "تێبینی": ""},
    "Monocytes": {"گروپ": "خوێن", "نۆرماڵ": (0.2, 0.8), "یەکە": "x10³/µL", "تەفسیر": "خڕۆکە مۆنۆسایتیکەکان", "ئامێر": "فلۆ سایتمیتەر (Sysmex XN-9000)", "تێبینی": ""},
    "Eosinophils": {"گروپ": "خوێن", "نۆرماڵ": (0.04, 0.4), "یەکە": "x10³/µL", "تەفسیر": "خڕۆکە ئیۆزینۆفیلیەکان", "ئامێر": "فلۆ سایتمیتەر (Sysmex XN-9000)", "تێبینی": ""},
    "Basophils": {"گروپ": "خوێن", "نۆرماڵ": (0.01, 0.1), "یەکە": "x10³/µL", "تەفسیر": "خڕۆکە باسۆفیلیەکان", "ئامێر": "فلۆ سایتمیتەر (Sysmex XN-9000)", "تێبینی": ""},
}

# 5.2 پشکنینەکانی بایۆکیمیایی (٧٥ پشکنین)
biochem_tests = {
    ...
    "Uric Acid": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (3.5, 7.5), "یەکە": "mg/dL", "تەفسیر": "ترشێتی یوریا", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)", "تێبینی": ""},
    "Creatinine Clearance": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (80, 120), "یەکە": "mL/min", "تەفسیر": "پاککردنەوەی گورچیلە", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)", "تێبینی": ""},
    "GFR": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (60, 120), "یەکە": "mL/min", "تەفسیر": "ڕێژەی پاڵەپەستۆی گورچیلە", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)", "تێبینی": ""},
    "Blood Gas pH": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (7.35, 7.45), "یەکە": "", "تەفسیر": "pH خوێن", "ئامێر": "ئانالایزەری خوێن (Roche Cobas b221)", "تێبینی": ""},
    "Blood Gas pCO2": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (35, 45), "یەکە": "mmHg", "تەفسیر": "پەستانی CO2", "ئامێر": "ئانالایزەری خوێن (Roche Cobas b221)", "تێبینی": ""},
    "Blood Gas pO2": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (80, 100), "یەکە": "mmHg", "تەفسیر": "پەستانی O2", "ئامێر": "ئانالایزەری خوێن (Roche Cobas b221)", "تێبینی": ""},
    "Blood Gas HCO3": {"گروپ": "بایۆکیمیایی", "نۆرماڵ": (22, 28), "یەکە": "mEq/L", "تەفسیر": "بی کاربۆنات", "ئامێر": "ئانالایزەری خوێن (Roche Cobas b221)", "تێبینی": ""},
}

# 5.3 پشکنینەکانی دڵ (٥٠ پشکنین)
cardiac_tests = {
    ...
    "NT-proBNP": {"گروپ": "دڵ", "نۆرماڵ": (0, 125), "یەکە": "pg/mL", "تەفسیر": "پروتێینی دڵ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "Cystatin C": {"گروپ": "دڵ", "نۆرماڵ": (0.5, 1.2), "یەکە": "mg/L", "تەفسیر": "پروتێینی گورچیلە", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)", "تێبینی": ""},
}

# 5.4 پشکنینەکانی هەوکردن (٥٠ پشکنین)
inflammation_tests = {
    "Procalcitonin": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 0.5), "یەکە": "ng/mL", "تەفسیر": "هەوکردنی بەکتریایی", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "IL-6": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 5), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)", "تێبینی": ""},
    "TNF-alpha": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 8), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)", "تێبینی": ""},
    "Ferritin": {"گروپ": "هەوکردن", "نۆرماڵ": (15, 300), "یەکە": "ng/mL", "تەفسیر": "ئاسن", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "LDH": {"گروپ": "هەوکردن", "نۆرماڵ": (100, 250), "یەکە": "U/L", "تەفسیر": "ئەنزیم", "ئامێر": "سپێکترۆفۆتۆمیتەر (Beckman Coulter AU480)", "تێبینی": ""},
    "Haptoglobin": {"گروپ": "هەوکردن", "نۆرماڵ": (50, 250), "یەکە": "mg/dL", "تەفسیر": "پروتێین", "ئامێر": "نێفێلۆمیتەر (Siemens BNII)", "تێبینی": ""},
    "Interferon-gamma": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 10), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)", "تێبینی": ""},
    "IL-1beta": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 2), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)", "تێبینی": ""},
    "IL-10": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 5), "یەکە": "pg/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)", "تێبینی": ""},
    "TGF-beta": {"گروپ": "هەوکردن", "نۆرماڵ": (0, 10), "یەکە": "ng/mL", "تەفسیر": "سایتۆکاینی هەوکردن", "ئامێر": "ELISA Reader (BioTek 800TS)", "تێبینی": ""},
}

# 5.5 پشکنینەکانی هۆرمۆن (٥٠ پشکنین)
hormone_tests = {
    ...
    "ACTH": {"گروپ": "هۆرمۆن", "نۆرماڵ": (10, 60), "یەکە": "pg/mL", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "Growth Hormone": {"گروپ": "هۆرمۆن", "نۆرماڵ": (0, 5), "یەکە": "ng/mL", "تەفسیر": "هۆرمۆنی گەشە", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "Prolactin": {"گروپ": "هۆرمۆن", "نۆرماڵ": (2, 15), "یەکە": "ng/mL", "تەفسیر": "هۆرمۆنی شیر", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    ...
    "Progesterone": {"گروپ": "هۆرمۆن", "نۆرماڵ": (0.2, 1.5), "یەکە": "ng/mL", "تەفسیر": "هۆرمۆنی مێ", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "DHEA-S": {"گروپ": "هۆرمۆن", "نۆرماڵ": (150, 500), "یەکە": "μg/dL", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "Aldosterone": {"گروپ": "هۆرمۆن", "نۆرماڵ": (3, 15), "یەکە": "ng/dL", "تەفسیر": "هۆرمۆنی نمەک", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "Renin": {"گروپ": "هۆرمۆن", "نۆرماڵ": (1.0, 3.0), "یەکە": "ng/mL/hr", "تەفسیر": "هۆرمۆنی گورچیلە", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "ACTH": {"گروپ": "هۆرمۆن", "نۆرماڵ": (10, 60), "یەکە": "pg/mL", "تەفسیر": "هۆرمۆنی دروان", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "ADH": {"گروپ": "هۆرمۆن", "نۆرماڵ": (1, 5), "یەکە": "pg/mL", "تەفسیر": "هۆرمۆنی ئاو", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
}

# 5.6 پشکنینەکانی میز (٥٠ پشکنین)
urine_tests = {
    ...
    "Urine Ketones": {"گروپ": "میز", "نۆرماڵ": (0, 0), "یەکە": "mg/dL", "تەفسیر": "کیتۆنی میز", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)", "تێبینی": ""},
    ...
    "Urine pH": {"گروپ": "میز", "نۆرماڵ": (5.0, 8.0), "یەکە": "", "تەفسیر": "pH میز", "ئامێر": "pH میتر (Hanna HI221)", "تێبینی": ""},
    "Urine Specific Gravity": {"گروپ": "میز", "نۆرماڵ": (1.005, 1.030), "یەکە": "", "تەفسیر": "چڕی میز", "ئامێر": "ریفڕاکتۆمیتەر (Atago PAL-10S)", "تێبینی": ""},
    "Urine Urea": {"گروپ": "میز", "نۆرماڵ": (20, 60), "یەکە": "mg/dL", "تەفسیر": "یوریای میز", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)", "تێبینی": ""},
    "Urine Creatinine": {"گروپ": "میز", "نۆرماڵ": (30, 300), "یەکە": "mg/dL", "تەفسیر": "کریاتینینی میز", "ئامێر": "سپێکترۆفۆتۆمیتەر (Roche Cobas c502)", "تێبینی": ""},
    "Urine Sodium": {"گروپ": "میز", "نۆرماڵ": (40, 220), "یەکە": "mmol/L", "تەفسیر": "سۆدیۆمی میز", "ئامێر": "ئایۆن سەلێکت یوڤ ئەنالایزەر (Roche Cobas c502)", "تێبینی": ""},
    "Urine Potassium": {"گروپ": "میز", "نۆرماڵ": (20, 80), "یەکە": "mmol/L", "تەفسیر": "پۆتاسیۆمی میز", "ئامێر": "ئایۆن سەلێکت یوڤ ئەنالایزەر (Roche Cobas c502)", "تێبینی": ""},
    "Urine Chloride": {"گروپ": "میز", "نۆرماڵ": (40, 220), "یەکە": "mmol/L", "تەفسیر": "کلۆرایدی میز", "ئامێر": "ئایۆن سەلێکت یوڤ ئەنالایزەر (Roche Cobas c502)", "تێبینی": ""},
}

# 5.7 پشکنینەکانی ڤیتامین (٣٠ پشکنین)
vitamin_tests = {
    ...
    "Vitamin K": {"گروپ": "ڤیتامین", "نۆرماڵ": (0.2, 3.0), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین K", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin C": {"گروپ": "ڤیتامین", "نۆرماڵ": (0.6, 2.0), "یەکە": "mg/dL", "تەفسیر": "ڤیتامین C", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B1": {"گروپ": "ڤیتامین", "نۆرماڵ": (2.5, 7.5), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین B1", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B2": {"گروپ": "ڤیتامین", "نۆرماڵ": (5, 20), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین B2", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B3": {"گروپ": "ڤیتامین", "نۆرماڵ": (200, 800), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین B3", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B5": {"گروپ": "ڤیتامین", "نۆرماڵ": (100, 400), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین B5", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B6": {"گروپ": "ڤیتامین", "نۆرماڵ": (5, 30), "یەکە": "ng/mL", "تەفسیر": "ڤیتامین B6", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B7": {"گروپ": "ڤیتامین", "نۆرماڵ": (100, 500), "یەکە": "pg/mL", "تەفسیر": "ڤیتامین B7", "ئامێر": "HPLC (Agilent 1200)", "تێبینی": ""},
    "Vitamin B9": {"گروپ": "ڤیتامین", "نۆرماڵ": (3, 17), "یەکە": "ng/mL", "تەفسیر": "فۆلیک ئەسید", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
    "Vitamin B12": {"گروپ": "ڤیتامین", "نۆرماڵ": (200, 900), "یەکە": "pg/mL", "تەفسیر": "ڤیتامین B12", "ئامێر": "کیمیایی ئیمینۆ (Roche Cobas e411)", "تێبینی": ""},
}

# 5.8 پشکنینەکانی معدن (٣٠ پشکنین)
mineral_tests = {
    "Zinc": {"گروپ": "معدن", "نۆرماڵ": (70, 120), "یەکە": "μg/dL", "تەفسیر": "زینک", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Selenium": {"گروپ": "معدن", "نۆرماڵ": (70, 150), "یەکە": "μg/L", "تەفسیر": "سێلینیۆم", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Copper": {"گروپ": "معدن", "نۆرماڵ": (70, 140), "یەکە": "μg/dL", "تەفسیر": "کۆپر", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Manganese": {"گروپ": "معدن", "نۆرماڵ": (4, 15), "یەکە": "μg/L", "تەفسیر": "مەنگەنیز", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Chromium": {"گروپ": "معدن", "نۆرماڵ": (0.5, 2.0), "یەکە": "μg/L", "تەفسیر": "کرۆمیۆم", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Iodine": {"گروپ": "معدن", "نۆرماڵ": (40, 100), "یەکە": "μg/L", "تەفسیر": "یۆد", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Fluoride": {"گروپ": "معدن", "نۆرماڵ": (0.5, 2.0), "یەکە": "mg/L", "تەفسیر": "فلۆراید", "ئامێر": "IC (Thermo Scientific ICS-5000)", "تێبینی": ""},
    "Lead": {"گروپ": "معدن", "نۆرماڵ": (0, 10), "یەکە": "μg/dL", "تەفسیر": "قورقوشم", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Mercury": {"گروپ": "معدن", "نۆرماڵ": (0, 5), "یەکە": "μg/L", "تەفسیر": "زێوی", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Arsenic": {"گروپ": "معدن", "نۆرماڵ": (0, 10), "یەکە": "μg/L", "تەفسیر": "ئارسەنیک", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
    "Cadmium": {"گروپ": "معدن", "نۆرماڵ": (0, 2), "یەکە": "μg/L", "تەفسیر": "کادمیۆم", "ئامێر": "ICP-MS (Agilent 7800)", "تێبینی": ""},
}
...
# ================================
# 6. داتابەسی دەرمانەکان (٣٠٠+ دەرمان) - بە وەسفی تەواو و تێبینی
# ================================
DRUG_DATABASE = {}

# 6.1 دژە پەستانی خوێن (٥٠ دەرمان)
anti_hypertensives = {
    ...
    "هیدروکلۆرۆتایزید": {"ڕێژە": "12.5-25mg", "میکانیزم": "Thiazide diuretic", "کاریگەری لاوەکی": "نزمی پۆتاسیۆم", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی دەرکەری ئاو کە شلەمەنی زیاد لە جەستە دەر دەکات", "بۆچی": "بۆ کەمکردنەوەی پەستانی خوێن بە دەرکردنی نمەک و ئاو", "تێبینی": ""},
    "فورۆسیماید": {"ڕێژە": "20-40mg", "میکانیزم": "Loop diuretic", "کاریگەری لاوەکی": "نزمی پۆتاسیۆم", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی دەرکەری بەهێز بۆ دەرکردنی ئاو و نمەک", "بۆچی": "بۆ چارەسەری پەستانی خوێن و ئاوسان لە نەخۆشی دڵ و گورچیلە", "تێبینی": ""},
    "کارڤیدیلۆل": {"ڕێژە": "6.25-25mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا کە خوێنبەرەکان فراوان دەکات", "بۆچی": "بۆ نەخۆشی دڵی شکان و پەستانی خوێن", "تێبینی": ""},
    "نایترۆگلیسیرین": {"ڕێژە": "0.3-0.6mg", "میکانیزم": "Nitrate", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نزمی BP", "وەسف": "دەرمانی فراوانکەری خوێنبەرەکان", "بۆچی": "بۆ چارەسەری ئازاری سنگ و نەخۆشی دڵی ئیسکیمیک", "تێبینی": ""},
    "ئیسۆسۆرباید": {"ڕێژە": "10-30mg", "میکانیزم": "Nitrate", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نزمی BP", "وەسف": "دەرمانی نایترات بۆ فراوانکردنی خوێنبەرەکان", "بۆچی": "بۆ پێشگیری لە ئازاری سنگ", "تێبینی": ""},
    "دیلتیازەم": {"ڕێژە": "30-60mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن و ئازاری سنگ", "تێبینی": ""},
    "ڤێراپامیل": {"ڕێژە": "40-80mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "خاوکردنەوەی دڵ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم کە دڵ خاو دەکاتەوە", "بۆچی": "بۆ چارەسەری ئازاری سنگ و پەستانی خوێن", "تێبینی": ""},
    "آتنۆلۆل": {"ڕێژە": "25-50mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "ماندوویی", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا بۆ کەمکردنەوەی کاری دڵ", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵ", "تێبینی": ""},
    "میتۆپرۆلۆل": {"ڕێژە": "25-50mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "خاوکردنەوەی دڵ", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا بۆ دڵ و خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵی شکان", "تێبینی": ""},
    "پروپانۆلۆل": {"ڕێژە": "10-40mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا بۆ کەمکردنەوەی دڵ", "بۆچی": "بۆ پەستانی خوێن، ئازاری سنگ، و خێرایی دڵ", "تێبینی": ""},
    "رامبەریل": {"ڕێژە": "1.25-5mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ کەمکردنەوەی پەستانی خوێن", "بۆچی": "بۆ پاراستنی گورچیلە و کەمکردنەوەی پەستانی خوێن", "تێبینی": ""},
    "کینیاپریل": {"ڕێژە": "5-20mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵ", "تێبینی": ""},
    "تێلمیسارتان": {"ڕێژە": "40-80mg", "میکانیزم": "ARB", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری گیرۆدەی ئەنجیۆتێنسین", "بۆچی": "بۆ پەستانی خوێن و پاراستنی گورچیلە", "تێبینی": ""},
    "ئیربێسارتان": {"ڕێژە": "150-300mg", "میکانیزم": "ARB", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "ARB بۆ کەمکردنەوەی پەستانی خوێن", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی گورچیلە", "تێبینی": ""},
    "فۆزینۆپریل": {"ڕێژە": "10-40mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "سپیرۆنۆلاکتۆن": {"ڕێژە": "25-50mg", "میکانیزم": "Aldosterone antagonist", "کاریگەری لاوەکی": "بەرزی پۆتاسیۆم", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دژە ئەلدۆستێرۆن بۆ دەرکردنی ئاو و نمەک", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵی شکان", "تێبینی": ""},
    "بینازپریل": {"ڕێژە": "5-20mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ کەمکردنەوەی پەستانی خوێن", "بۆچی": "بۆ پەستانی خوێن و نەخۆشی دڵ", "تێبینی": ""},
    "سیلازاپریل": {"ڕێژە": "1-2.5mg", "میکانیزم": "ACE inhibitor", "کاریگەری لاوەکی": "کۆخە", "پێچەوانە": "حەمل", "وەسف": "ACE inhibitor بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "دیلتیازەم": {"ڕێژە": "30-60mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن و ئازاری سنگ", "تێبینی": ""},
    "نیفیدیپین": {"ڕێژە": "10-30mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم بۆ خوێنبەرەکان", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "فلودیپین": {"ڕێژە": "2.5-10mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "دازادابین": {"ڕێژە": "2.5-5mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "لاسیدابین": {"ڕێژە": "2.5-5mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "نیتراندیپین": {"ڕێژە": "10-20mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "مانیدابین": {"ڕێژە": "5-10mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "نیورولادین": {"ڕێژە": "5-10mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "آملودیپین": {"ڕێژە": "5-10mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "فیلودیپین": {"ڕێژە": "2.5-10mg", "میکانیزم": "Calcium blocker", "کاریگەری لاوەکی": "ئاوسانی قاچ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری کالسیۆم", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "کلونیدین": {"ڕێژە": "0.1-0.3mg", "میکانیزم": "Alpha-2 agonist", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "هاندهری ئەلفا-2 بۆ کەمکردنەوەی BP", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "میثیلدۆپا": {"ڕێژە": "250-500mg", "میکانیزم": "Alpha-2 agonist", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "هاندهری ئەلفا-2 بۆ کەمکردنەوەی BP", "بۆچی": "بۆ پەستانی خوێن لە حەملی دووگانی", "تێبینی": ""},
    "گوانفاسین": {"ڕێژە": "1-3mg", "میکانیزم": "Alpha-2 agonist", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "هاندهری ئەلفا-2", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "دروەک": {"ڕێژە": "1-2mg", "میکانیزم": "Alpha-2 agonist", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "هاندهری ئەلفا-2", "بۆچی": "بۆ پەستانی خوێن", "تێبینی": ""},
    "مەکسیلیتین": {"ڕێژە": "200-400mg", "میکانیزم": "Antiarrhythmic", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە خێرایی دڵ", "بۆچی": "بۆ خێرایی دڵ", "تێبینی": ""},
    "ئەمیۆدارۆن": {"ڕێژە": "200-400mg", "میکانیزم": "Antiarrhythmic", "کاریگەری لاوەکی": "زیان بە جگەر", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "دژە خێرایی دڵ", "بۆچی": "بۆ خێرایی دڵ", "تێبینی": ""},
    "سۆتالۆل": {"ڕێژە": "40-80mg", "میکانیزم": "Beta blocker", "کاریگەری لاوەکی": "خاوکردنەوەی دڵ", "پێچەوانە": "ئەستمی هەوە", "وەسف": "بەربەستەری بیتا", "بۆچی": "بۆ خێرایی دڵ", "تێبینی": ""},
    "دۆفتیلاید": {"ڕێژە": "0.25-0.5mg", "میکانیزم": "Antiarrhythmic", "کاریگەری لاوەکی": "خێرایی دڵ", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دژە خێرایی دڵ", "بۆچی": "بۆ خێرایی دڵ", "تێبینی": ""},
    "فلیکایناید": {"ڕێژە": "50-100mg", "میکانیزم": "Antiarrhythmic", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە خێرایی دڵ", "بۆچی": "بۆ خێرایی دڵ", "تێبینی": ""},
}

# 6.2 دژە شەکرە (٤٠ دەرمان)
anti_diabetics = {
    "مێتفۆرمین": {"ڕێژە": "500-2000mg", "میکانیزم": "Biguanide", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی هێڵی یەکەم بۆ شەکرەی جۆری ٢ - کەمکردنی بەرهەمهێنانی شەکر لە جگەر و زیادکردنی هەستی ئەنسولین", "بۆچی": "بۆ کۆنتڕۆڵکردنی شەکری خوێن لە نەخۆشانی شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیپیزاید": {"ڕێژە": "5-20mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هەستیاری", "وەسف": "دەرمانی سەلفۆنیل یوریا کە پەنکریاس هان دەدات بۆ بەرهەمهێنانی زیاتری ئەنسولین", "بۆچی": "بۆ کەمکردنەوەی شەکری خوێن لە شەکرەی جۆری ٢", "تێبینی": ""},
    "ئەنسولین Glargine": {"ڕێژە": "10-40 IU", "میکانیزم": "Insulin analog", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی درێژخایەن کە شەکر بە درێژایی ٢٤ کاتژمێر کۆنتڕۆڵ دەکات", "بۆچی": "بۆ کۆنتڕۆڵی شەکری خوێن لە شەکرەی جۆری ١ و جۆری ٢", "تێبینی": ""},
    "سیتاگلیپتین": {"ڕێژە": "100mg", "میکانیزم": "DPP-4 inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "بەربەستەری DPP-4 کە ئاستی GLP-1 زیاد دەکات بۆ کەمکردنەوەی شەکر", "بۆچی": "بۆ کۆنتڕۆڵی شەکری خوێن لە شەکرەی جۆری ٢", "تێبینی": ""},
    "ساکساگلیپتین": {"ڕێژە": "5mg", "میکانیزم": "DPP-4 inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "بەربەستەری DPP-4 بۆ کەمکردنەوەی شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "لیناگلیپتین": {"ڕێژە": "5mg", "میکانیزم": "DPP-4 inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "بەربەستەری DPP-4 بۆ شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ئەلبیکوتاید": {"ڕێژە": "1-2mg", "میکانیزم": "GLP-1 agonist", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "هاندهری GLP-1 بۆ کەمکردنەوەی شەکر و کێش", "بۆچی": "بۆ شەکرەی جۆری ٢ و کەمکردنەوەی کێش", "تێبینی": ""},
    "لیراگلوتاید": {"ڕێژە": "0.6-1.8mg", "میکانیزم": "GLP-1 agonist", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "هاندهری GLP-1 بۆ کۆنتڕۆڵی شەکر و کەمکردنەوەی کێش", "بۆچی": "بۆ شەکرەی جۆری ٢ و نەخۆشی دڵ", "تێبینی": ""},
    "دولاگلوتاید": {"ڕێژە": "0.75-1.5mg", "میکانیزم": "GLP-1 agonist", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی پەنکریاس", "وەسف": "هاندهری GLP-1 بۆ کۆنتڕۆڵی شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ئەنسولین Aspart": {"ڕێژە": "2-10 IU", "میکانیزم": "Insulin analog", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی خێرا بۆ کۆنتڕۆڵی شەکری پاش خواردن", "بۆچی": "بۆ شەکرەی جۆری ١ و جۆری ٢", "تێبینی": ""},
    "ئەنسولین Lispro": {"ڕێژە": "2-10 IU", "میکانیزم": "Insulin analog", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی خێرا بۆ کۆنتڕۆڵی شەکر", "بۆچی": "بۆ شەکرەی جۆری ١ و جۆری ٢", "تێبینی": ""},
    "ئەنسولین Regular": {"ڕێژە": "2-10 IU", "میکانیزم": "Insulin", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هایپۆگلایسیمیا", "وەسف": "ئەنسولینی ستاندارد بۆ کۆنتڕۆڵی شەکر", "بۆچی": "بۆ شەکرەی جۆری ١ و جۆری ٢", "تێبینی": ""},
    "گلیمێپیراید": {"ڕێژە": "1-4mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هەستیاری", "وەسف": "سەلفۆنیل یوریا بۆ زیادی ئەنسولین", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "پایۆگلیتازۆن": {"ڕێژە": "15-45mg", "میکانیزم": "Thiazolidinedione", "کاریگەری لاوەکی": "ئاوسان", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "زیادکەری هەستی ئەنسولین لە شانەکاندا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ئەکاربۆز": {"ڕێژە": "25-50mg", "میکانیزم": "Alpha-glucosidase inhibitor", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گەدە", "وەسف": "بەربەستەری هەرسکردنی کاربۆهیدرات بۆ کەمکردنەوەی شەکر", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "میگلیتۆل": {"ڕێژە": "25-50mg", "میکانیزم": "Alpha-glucosidase inhibitor", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گەدە", "وەسف": "بەربەستەری هەرسکردنی کاربۆهیدرات", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیبۆرنوراید": {"ڕێژە": "5-10mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ناتگلیناید": {"ڕێژە": "60-120mg", "میکانیزم": "Meglitinide", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "هاندهری خێرای ئەنسولین", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ریپاگلیناید": {"ڕێژە": "0.5-2mg", "میکانیزم": "Meglitinide", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "هاندهری خێرای ئەنسولین", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیمپیراید": {"ڕێژە": "1-4mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "هەستیاری", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیکوزید": {"ڕێژە": "2.5-5mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیبوراید": {"ڕێژە": "5-10mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیپیزاید": {"ڕێژە": "5-20mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیمپیراید": {"ڕێژە": "1-4mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "گلیبۆرنوراید": {"ڕێژە": "5-10mg", "میکانیزم": "Sulfonylurea", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "سەلفۆنیل یوریا", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ئەکاربۆز": {"ڕێژە": "25-50mg", "میکانیزم": "Alpha-glucosidase inhibitor", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گەدە", "وەسف": "بەربەستەری هەرسکردنی کاربۆهیدرات", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "میگلیتۆل": {"ڕێژە": "25-50mg", "میکانیزم": "Alpha-glucosidase inhibitor", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گەدە", "وەسف": "بەربەستەری هەرسکردنی کاربۆهیدرات", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ناتگلیناید": {"ڕێژە": "60-120mg", "میکانیزم": "Meglitinide", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "هاندهری خێرای ئەنسولین", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
    "ریپاگلیناید": {"ڕێژە": "0.5-2mg", "میکانیزم": "Meglitinide", "کاریگەری لاوەکی": "هایپۆگلایسیمیا", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "هاندهری خێرای ئەنسولین", "بۆچی": "بۆ شەکرەی جۆری ٢", "تێبینی": ""},
}

# 6.3 دژە کۆخە و هەوکردن (٤٠ دەرمان)
anti_infectives = {
    "ئەمۆکسیسیلین": {"ڕێژە": "500mg", "میکانیزم": "Beta-lactam", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "هەستیاری پێنیسیلین", "وەسف": "ئەنتیبایۆتیکی پێنیسیلین بۆ هەوکردنی بەکتریایی", "بۆچی": "بۆ هەوکردنی سییەکان، گەدە، میز", "تێبینی": ""},
    "ئازیترۆمایسین": {"ڕێژە": "250-500mg", "میکانیزم": "Macrolide", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "ئەنتیبایۆتیکی ماکرۆلید بۆ هەوکردنی هەناسە", "بۆچی": "بۆ هەوکردنی سییەکان و کۆکە", "تێبینی": ""},
    "سیپرۆفلۆکساسین": {"ڕێژە": "500mg", "میکانیزم": "Fluoroquinolone", "کاریگەری لاوەکی": "ئازاری ماسوولکە", "پێچەوانە": "منداڵان", "وەسف": "ئەنتیبایۆتیکی فلۆرۆکینۆلۆن بۆ هەوکردنی بەکتریایی", "بۆچی": "بۆ هەوکردنی میز و سییەکان", "تێبینی": ""},
    "سێفتریاکسۆن": {"ڕێژە": "1-2g", "میکانیزم": "Cephalosporin", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "هەستیاری", "وەسف": "ئەنتیبایۆتیکی سێفالۆسپۆرین بۆ هەوکردنی توند", "بۆچی": "بۆ هەوکردنی سییەکان، گورچیلە، و خوێن", "تێبینی": ""},
    "دۆکسیسایکلین": {"ڕێژە": "100mg", "میکانیزم": "Tetracycline", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "منداڵان", "وەسف": "ئەنتیبایۆتیکی تێتراسایکلین بۆ هەوکردنی جۆراوجۆر", "بۆچی": "بۆ هەوکردنی سییەکان، کۆلێرا، و سیل", "تێبینی": ""},
    "تتراسایکلین": {"ڕێژە": "250-500mg", "میکانیزم": "Tetracycline", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "منداڵان", "وەسف": "ئەنتیبایۆتیکی تێتراسایکلین", "بۆچی": "بۆ هەوکردنی پێست و سییەکان", "تێبینی": ""},
    "کوتریمۆکسازۆل": {"ڕێژە": "400-800mg", "میکانیزم": "Sulfonamide", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "هەستیاری", "وەسف": "ئەنتیبایۆتیکی سەلفۆنامید", "بۆچی": "بۆ هەوکردنی میز و سییەکان", "تێبینی": ""},
    "مێترۆنیدازۆل": {"ڕێژە": "250-500mg", "میکانیزم": "Nitroimidazole", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "حەمل", "وەسف": "ئەنتیبایۆتیک بۆ بەکتریای ئانایروب", "بۆچی": "بۆ هەوکردنی گەدە و خوێن", "تێبینی": ""},
    "فینوکسیمایسین": {"ڕێژە": "250mg", "میکانیزم": "Macrolide", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "ئەنتیبایۆتیکی ماکرۆلید", "بۆچی": "بۆ هەوکردنی هەناسە", "تێبینی": ""},
    "سێفیکسیم": {"ڕێژە": "400mg", "میکانیزم": "Cephalosporin", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "هەستیاری", "وەسف": "سێفالۆسپۆرین بۆ هەوکردنی میز و سییەکان", "بۆچی": "بۆ هەوکردنی میز و کۆکە", "تێبینی": ""},
    "لیفلوکسایسین": {"ڕێژە": "500mg", "میکانیزم": "Fluoroquinolone", "کاریگەری لاوەکی": "ئازاری ماسوولکە", "پێچەوانە": "منداڵان", "وەسف": "فلۆرۆکینۆلۆن بۆ هەوکردن", "بۆچی": "بۆ هەوکردنی سییەکان و میز", "تێبینی": ""},
    "مۆکسیفلۆکساسین": {"ڕێژە": "400mg", "میکانیزم": "Fluoroquinolone", "کاریگەری لاوەکی": "ئازاری ماسوولکە", "پێچەوانە": "منداڵان", "وەسف": "فلۆرۆکینۆلۆن", "بۆچی": "بۆ هەوکردنی سییەکان", "تێبینی": ""},
    "ریفامپیسین": {"ڕێژە": "600mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "زەردبوون", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل", "تێبینی": ""},
    "ئایسۆنیازید": {"ڕێژە": "300mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "زیان بە جگەر", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل", "تێبینی": ""},
    "پیرازیناماید": {"ڕێژە": "1500mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "ئازاری جومگە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل", "تێبینی": ""},
    "ئیتامبوتۆل": {"ڕێژە": "800mg", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "کەمبوونی بینین", "پێچەوانە": "نەخۆشی چاو", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل", "تێبینی": ""},
    "سترێپتۆمایسین": {"ڕێژە": "1g", "میکانیزم": "Antibiotic", "کاریگەری لاوەکی": "زیان بە گوێ", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "ئەنتیبایۆتیک بۆ سیل", "بۆچی": "بۆ چارەسەری سیل", "تێبینی": ""},
    "جینتامایسین": {"ڕێژە": "2mg/kg", "میکانیزم": "Aminoglycoside", "کاریگەری لاوەکی": "زیان بە گورچیلە", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "ئەنتیبایۆتیک بۆ هەوکردنی بەکتریایی", "بۆچی": "بۆ هەوکردنی خوێن و میز", "تێبینی": ""},
    "ئامیکاسین": {"ڕێژە": "15mg/kg", "میکانیزم": "Aminoglycoside", "کاریگەری لاوەکی": "زیان بە گورچیلە", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "ئەنتیبایۆتیک بۆ هەوکردنی بەکتریایی", "بۆچی": "بۆ هەوکردنی خوێن و سییەکان", "تێبینی": ""},
    "ڤانکۆمایسین": {"ڕێژە": "1g", "میکانیزم": "Glycopeptide", "کاریگەری لاوەکی": "زیان بە گورچیلە", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "ئەنتیبایۆتیک بۆ بەکتریای مەترسیدار", "بۆچی": "بۆ هەوکردنی خوێن و دڵ", "تێبینی": ""},
}

# 6.4 دژە ئەنیمیا (٢٠ دەرمان)
anti_anemia = {
    "فێروس سولفەیت": {"ڕێژە": "300-600mg", "میکانیزم": "Iron supplement", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "هیمۆکروماتۆسیس", "وەسف": "پڕکەری ئاسن بۆ چارەسەری ئەنیمیای کەمخوێنی ئاسن", "بۆچی": "بۆ زیادی ئاسن لە جەستە و چارەسەری ئەنیمیا", "تێبینی": ""},
    "فۆلیک ئەسید": {"ڕێژە": "1mg", "میکانیزم": "Folate supplement", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری فۆلیک ئەسید بۆ ئەنیمیای ماکرۆسایتیک", "بۆچی": "بۆ زیادکردنی فۆلیک ئەسید و چارەسەری ئەنیمیا", "تێبینی": ""},
    "ڤیتامین B12": {"ڕێژە": "1000mcg", "میکانیزم": "Cobalamin", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری ڤیتامین B12 بۆ ئەنیمیای ماکرۆسایتیک", "بۆچی": "بۆ چارەسەری ئەنیمیای کەمخوێنی B12", "تێبینی": ""},
    "ئەریترۆپۆیتین": {"ڕێژە": "50-100 IU/kg", "میکانیزم": "Erythropoietin", "کاریگەری لاوەکی": "BP بەرز", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "هۆرمۆنی دروستکردنی خڕۆکە سوورەکان", "بۆچی": "بۆ زیادکردنی خڕۆکە سوورەکان لە نەخۆشی گورچیلە", "تێبینی": ""},
    "سیانۆکۆبالامین": {"ڕێژە": "1000mcg", "میکانیزم": "Vitamin B12", "کاریگەری لاوەکی": "کەم", "پێچەوانە": "هەستیاری", "وەسف": "پڕکەری ڤیتامین B12", "بۆچی": "بۆ ئەنیمیای ماکرۆسایتیک", "تێبینی": ""},
    "ئاسن دیکستران": {"ڕێژە": "100-200mg", "میکانیزم": "Iron supplement", "کاریگەری لاوەکی": "هەستیاری", "پێچەوانە": "هیمۆکروماتۆسیس", "وەسف": "پڕکەری ئاسن بۆ نەخۆشانی گورچیلە", "بۆچی": "بۆ چارەسەری ئەنیمیای کەمخوێنی ئاسن", "تێبینی": ""},
    "دێسفێریۆکسامین": {"ڕێژە": "500-1000mg", "میکانیزم": "Iron chelator", "کاریگەری لاوەکی": "زیان بە گورچیلە", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دەرمانی دەرکردنی ئاسنی زۆر لە جەستە", "بۆچی": "بۆ چارەسەری هیمۆکروماتۆسیس", "تێبینی": ""},
    "دەیکسۆمیتازۆن": {"ڕێژە": "0.5-2mg", "میکانیزم": "Steroid", "کاریگەری لاوەکی": "کێش زیادکردن", "پێچەوانە": "هەوکردن", "وەسف": "ستیرۆید بۆ هەوکردن و ئەنیمیا", "بۆچی": "بۆ چارەسەری ئەنیمیای هیمۆلایتیک", "تێبینی": ""},
    "پرەدنیسۆلۆن": {"ڕێژە": "5-20mg", "میکانیزم": "Steroid", "کاریگەری لاوەکی": "کێش زیادکردن", "پێچەوانە": "هەوکردن", "وەسف": "ستیرۆید بۆ هەوکردن و خۆئەگەری", "بۆچی": "بۆ ئەنیمیای هیمۆلایتیک", "تێبینی": ""},
    "ئەسپیرین": {"ڕێژە": "75-300mg", "میکانیزم": "NSAID", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە ئازار و دژە تەمەن بۆ کەمکردنەوەی ئازار و تا", "بۆچی": "بۆ ئازاری کەم و ناوەند و پێشگیری لە خوێن مەبەست", "تێبینی": ""},
    ...
    "نابومیتۆن": {"ڕێژە": "500mg", "میکانیزم": "NSAID", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "دژە هەوکردن بۆ ئازاری جومگەکان", "بۆچی": "بۆ ئازاری جومگە و ئارتریت", "تێبینی": ""},
    "پاراستامۆل": {"ڕێژە": "500-1000mg", "میکانیزم": "Analgesic", "کاریگەری لاوەکی": "زیان بە جگەر", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "دژە ئازار و دژە تەمەن بۆ هەموو ئازارەکان", "بۆچی": "بۆ ئازاری سەرئێشە و تا", "تێبینی": ""},
    "مۆرفین": {"ڕێژە": "5-10mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "خەوی", "پێچەوانە": "نەخۆشی هەناسە", "وەسف": "دژە ئازاری بەهێز بۆ ئازاری توند", "بۆچی": "بۆ ئازاری توند وەک ئازاری شێرپەنجە", "تێبینی": ""},
    "کۆدەین": {"ڕێژە": "30mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "منداڵان", "وەسف": "دژە ئازاری مامناوەند", "بۆچی": "بۆ ئازاری مامناوەند", "تێبینی": ""},
    "ترامادۆل": {"ڕێژە": "50mg", "میکانیزم": "Opioid", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە ئازاری نا ئۆپیۆیدی", "بۆچی": "بۆ ئازاری مامناوەند", "تێبینی": ""},
}

# 6.5 دژە کۆکە (٣٠ دەرمان)
anti_asthma = {
    "سالبوتامۆل": {"ڕێژە": "2 puffs", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە بۆ کۆکە", "بۆچی": "بۆ چارەسەری کۆکە و COPD", "تێبینی": ""},
    "بۆدیزۆناید": {"ڕێژە": "200-800mcg", "میکانیزم": "Steroid inhaler", "کاریگەری لاوەکی": "هەوکردنی دەم", "پێچەوانە": "هەستیاری", "وەسف": "ستیرۆیدی هەناسەدان بۆ کەمکردنەوەی هەوکردن", "بۆچی": "بۆ پێشگیری لە کۆکە", "تێبینی": ""},
    "فۆرمۆتێرۆل": {"ڕێژە": "6-12mcg", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە و COPD", "تێبینی": ""},
    "فلوتیکاسۆن": {"ڕێژە": "250-500mcg", "میکانیزم": "Steroid inhaler", "کاریگەری لاوەکی": "هەوکردنی دەم", "پێچەوانە": "هەستیاری", "وەسف": "ستیرۆیدی هەناسەدان", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "مۆنتلۆکاست": {"ڕێژە": "10mg", "میکانیزم": "Leukotriene inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "هەستیاری", "وەسف": "بەربەستەری لیوکۆترین بۆ کەمکردنەوەی هەوکردن", "بۆچی": "بۆ کۆکە و هەستێکی هەوە", "تێبینی": ""},
    "زافیرلوکاست": {"ڕێژە": "20mg", "میکانیزم": "Leukotriene inhibitor", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "هەستیاری", "وەسف": "بەربەستەری لیوکۆترین", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "تیۆترۆپیۆم": {"ڕێژە": "18mcg", "میکانیزم": "Anticholinergic", "کاریگەری لاوەکی": "دەم وشک", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری ئەستیلکۆلین بۆ فراوانکردنی بۆڕی هەناسە", "بۆچی": "بۆ COPD و کۆکە", "تێبینی": ""},
    "ئیپرەترۆپیۆم": {"ڕێژە": "20mcg", "میکانیزم": "Anticholinergic", "کاریگەری لاوەکی": "دەم وشک", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "بەربەستەری ئەستیلکۆلین", "بۆچی": "بۆ COPD", "تێبینی": ""},
    "تئۆفیلین": {"ڕێژە": "100-200mg", "میکانیزم": "Bronchodilator", "کاریگەری لاوەکی": "خێرالێدانی دڵ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە و COPD", "تێبینی": ""},
    "ئامینۆفیلین": {"ڕێژە": "100-200mg", "میکانیزم": "Bronchodilator", "کاریگەری لاوەکی": "خێرالێدانی دڵ", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "سالبوتامۆل": {"ڕێژە": "2 puffs", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "تێربوتالین": {"ڕێژە": "2.5mg", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "فینۆتێرۆل": {"ڕێژە": "0.2mg", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "کلێنبوتێرۆل": {"ڕێژە": "20mcg", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
    "بامبوتێرۆل": {"ڕێژە": "10mg", "میکانیزم": "Beta-2 agonist", "کاریگەری لاوەکی": "لەرزین", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "فراوانکەری بۆڕی هەناسە", "بۆچی": "بۆ کۆکە", "تێبینی": ""},
}

# 6.6 دژە سکچوون (٣٠ دەرمان)
anti_ulcer = {
    "ئومەپرازۆل": {"ڕێژە": "20-40mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن بۆ کەمکردنەوەی ترشێتی گەدە", "بۆچی": "بۆ چارەسەری سکچوون و برینداری گەدە", "تێبینی": ""},
    "لانسۆپرازۆل": {"ڕێژە": "30mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "پانتۆپرازۆل": {"ڕێژە": "40mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ گەدە و سکچوون", "تێبینی": ""},
    "ڕابێپرازۆل": {"ڕێژە": "20mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "PPI بۆ کەمکردنەوەی ترشێتی", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "ڕانیتیدین": {"ڕێژە": "150mg", "میکانیزم": "H2 blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری H2 بۆ کەمکردنەوەی ترشێتی", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "فامۆتیدین": {"ڕێژە": "20-40mg", "میکانیزم": "H2 blocker", "کاریگەری لاوەکی": "سەرگێژخواردن", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری H2", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "سوکرالفەیت": {"ڕێژە": "1g", "میکانیزم": "Mucosal protectant", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "پارێزەری پەردەی گەدە", "بۆچی": "بۆ برینداری گەدە", "تێبینی": ""},
    "بسمەت سابیسیلیت": {"ڕێژە": "262mg", "میکانیزم": "Antidiarrheal", "کاریگەری لاوەکی": "زکچوون", "پێچەوانە": "منداڵان", "وەسف": "دژە سکچوون بۆ کەمکردنەوەی سکچوون", "بۆچی": "بۆ سکچوون و گەدە", "تێبینی": ""},
    "میزۆپرۆستۆل": {"ڕێژە": "100-200mcg", "میکانیزم": "Prostaglandin", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "حەمل", "وەسف": "پرۆستاگلاندین بۆ پاراستنی گەدە", "بۆچی": "بۆ پێشگیری لە برینداری گەدە لە NSAIDs", "تێبینی": ""},
    "سوکرالفەیت": {"ڕێژە": "1g", "میکانیزم": "Mucosal protectant", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "پارێزەری گەدە", "بۆچی": "بۆ برینداری گەدە", "تێبینی": ""},
    "ئومەپرازۆل": {"ڕێژە": "20-40mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "لانسۆپرازۆل": {"ڕێژە": "30mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "پانتۆپرازۆل": {"ڕێژە": "40mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "بەربەستەری پمپەی پرۆتۆن", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
    "ڕابێپرازۆل": {"ڕێژە": "20mg", "میکانیزم": "PPI", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی جگەر", "وەسف": "PPI", "بۆچی": "بۆ سکچوون", "تێبینی": ""},
...
# 6.7 دژە خوێن (٣٠ دەرمان)
anticoagulants = {
    "وارفارین": {"ڕێژە": "5mg", "میکانیزم": "Vitamin K antagonist", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "حەمل", "وەسف": "دژە خوێن بۆ پێشگیری لە مەبەست", "بۆچی": "بۆ پێشگیری لە خوێن مەبەست", "تێبینی": ""},
    "هێپارین": {"ڕێژە": "5000 IU", "میکانیزم": "Anticoagulant", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە خوێنی خێرا بۆ نەخۆشخانە", "بۆچی": "بۆ پێشگیری لە مەبەست", "تێبینی": ""},
    "ئەنۆکساپارین": {"ڕێژە": "40mg", "میکانیزم": "LMWH", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە خوێنی کەم کێش", "بۆچی": "بۆ پێشگیری لە مەبەست", "تێبینی": ""},
    "کلۆپیدۆگرێل": {"ڕێژە": "75mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت بۆ پێشگیری لە مەبەست", "بۆچی": "بۆ نەخۆشی دڵی ئیسکیمیک", "تێبینی": ""},
    "پراسوگرێل": {"ڕێژە": "10mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ ئازاری سنگ", "تێبینی": ""},
    "تیکاگرێلۆر": {"ڕێژە": "90mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ نەخۆشی دڵ", "تێبینی": ""},
    "دابیگاتران": {"ڕێژە": "110mg", "میکانیزم": "Direct thrombin inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری ترۆمبین", "بۆچی": "بۆ پێشگیری لە مەبەست", "تێبینی": ""},
    "ریڤارۆکسابان": {"ڕێژە": "10mg", "میکانیزم": "Factor Xa inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری فاکتۆر Xa", "بۆچی": "بۆ مەبەست", "تێبینی": ""},
    "ئەپیکسابان": {"ڕێژە": "2.5-5mg", "میکانیزم": "Factor Xa inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری فاکتۆر Xa", "بۆچی": "بۆ مەبەست", "تێبینی": ""},
    "ئیدۆکسابان": {"ڕێژە": "30-60mg", "میکانیزم": "Factor Xa inhibitor", "کاریگەری لاوەکی": "خوێنبەربوون", "پێچەوانە": "نەخۆشی گورچیلە", "وەسف": "بەربەستەری فاکتۆر Xa", "بۆچی": "بۆ مەبەست", "تێبینی": ""},
    "ئەسپیرین": {"ڕێژە": "75-300mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "سکچوون", "پێچەوانە": "خوێنبەربوون", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ پێشگیری لە مەبەست", "تێبینی": ""},
    "دیپیریدامۆل": {"ڕێژە": "100-200mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ پێشگیری لە مەبەست", "تێبینی": ""},
    "سیلۆستازۆل": {"ڕێژە": "100mg", "میکانیزم": "Antiplatelet", "کاریگەری لاوەکی": "سەرئێشە", "پێچەوانە": "نەخۆشی دڵ", "وەسف": "دژە پلەیتلێت", "بۆچی": "بۆ پێشگیری لە مەبەست", "تێبینی": ""},
}

# یەکخستنی هەموو دەرمانەکان
for drug_dict in [anti_hypertensives, anti_diabetics, anti_infectives, anti_anemia, anti_asthma, anti_ulcer, anticoagulants]:
    DRUG_DATABASE.update(drug_dict)
...
def generate_quizzes_by_level():
    ...
    # پرس وەڵامەکان بۆ ئاستی ٣ (پێشکەوتوو)
    level3_questions = [
    ...
    # پرس وەڵامەکان بۆ ئاستی ٤ (شارەزا)
    level4_questions = [
    ...
    # پرس وەڵامەکان بۆ ئاستی ٥ (پزیشک)
    level5_questions = [
...
with st.sidebar:
    ...
    st.markdown(f"**📝 نۆتە:** {len(st.session_state.clinical_notes)}")
...
# ================================
# 15. پەڕەی تاقیگە (٣٠٠ پشکنین)
# ================================
elif page == "🔬 تاقیگە (٣٠٠)":
    st.markdown("""
    <div class="main">
        <h2>🔬 تاقیگەی ڤێرچواڵ - Dr.Danyal</h2>
        <p style="color:#aaa;">٣٠٠+ پشکنینی تاقیگە لەگەڵ ئامێرەکان و شوێنی تێبینی تایبەتی خۆت</p>
    </div>
    """, unsafe_allow_html=True)
...
# ================================
    ...
    <div class="main">
        ...
        <p style="color:#aaa;">٣٠٠+ دەرمان لەگەڵ وەسف و شوێنی تێبینی تایبەتی خۆت</p>
    </div>
    """, unsafe_allow_html=True)
    
    # گروپەکانی دەرمان
    drug_categories = {
        "دژە پەستانی خوێن": [k for k in DRUG_DATABASE.keys() if k in anti_hypertensives],
        "دژە شەکرە": [k for k in DRUG_DATABASE.keys() if k in anti_diabetics],
        "دژە کۆخە و هەوکردن": [k for k in DRUG_DATABASE.keys() if k in anti_infectives],
        "دژە ئەنیمیا": [k for k in DRUG_DATABASE.keys() if k in anti_anemia],
        "دژە کۆکە": [k for k in DRUG_DATABASE.keys() if k in anti_asthma],
        "دژە سکچوون": [k for k in DRUG_DATABASE.keys() if k in anti_ulcer],
        "دژە خوێن": [k for k in DRUG_DATABASE.keys() if k in anticoagulants],
        "دەرمانەکانی تر": [k for k in DRUG_DATABASE.keys() if k not in anti_hypertensives and k not in anti_diabetics and k not in anti_infectives and k not in anti_anemia and k not in anti_asthma and k not in anti_ulcer and k not in anticoagulants]
    }
    ...
    for category, drug_list in drug_categories.items():
        if not drug_list:
            continue
        filtered_drugs = {k: DRUG_DATABASE[k] for k in drug_list if k in DRUG_DATABASE}
        if search_drug:
            filtered_drugs = {k: v for k, v in filtered_drugs.items() if search_drug.lower() in k.lower() or search_drug.lower() in category.lower()}
            if not filtered_drugs:
                continue
        
        with st.expander(f"📂 {category} ({len(filtered_drugs)} دەرمان)"):
            cols = st.columns(2)
            idx = 0
            for drug, info in filtered_drugs.items():
                with cols[idx % 2]:
...
# ================================
    ...
    all_achievements = [
        ...
        {"icon": "📝", "name": "نۆتەنووس", "condition": len(st.session_state.clinical_notes) >= 5},
        {"icon": "🎯", "name": "پزیشکی دەق", "condition": st.session_state.quiz_score >= 90}
    ]
...
# ================================
# 21. پەڕەی نۆتە کلینیکی
# ================================
elif page == "📝 نۆتە کلینیکی":
    st.markdown("""
    <div class="main">
        <h2>📝 نۆتە کلینیکی - Dr.Danyal</h2>
        <p style="color:#aaa;">نۆتەکانت لەسەر نەخۆشییەکان و دەرمانەکان بنووسە</p>
    </div>
    """, unsafe_allow_html=True)
    
    # هەڵبژاردنی نەخۆشی یان دەرمان
    col1, col2 = st.columns(2)
    with col1:
        disease_for_note = st.selectbox("نەخۆشی (ئەگەر پەیوەست بێت):", ["هیچ"] + list(DISEASE_DATABASE.keys()))
    with col2:
        drug_for_note = st.selectbox("دەرمان (ئەگەر پەیوەست بێت):", ["هیچ"] + list(DRUG_DATABASE.keys()))
    
    # نوسینی نۆتە
    note_text = st.text_area("📝 نۆتەکەت بنووسە:", placeholder="وەک: نیشانەکانی ئەم نەخۆشییە... یان کاریگەری لاوەکی ئەم دەرمانە...", height=150)
    
    if st.button("✅ نۆتەکە زیاد بکە", type="primary"):
        if note_text.strip():
            # دروستکردنی نۆتە
            note_content = note_text.strip()
            if disease_for_note != "هیچ":
                note_content = f"نەخۆشی: {disease_for_note}\n{note_content}"
            if drug_for_note != "هیچ":
                note_content = f"دەرمان: {drug_for_note}\n{note_content}"
            
            # زیادکردنی نۆتە
            st.session_state.clinical_notes.append({
                "note": note_content,
                "timestamp": datetime.now().isoformat(),
                "disease": disease_for_note if disease_for_note != "هیچ" else None,
                "drug": drug_for_note if drug_for_note != "هیچ" else None
            })
            auto_save()
            st.success("نۆتەکە بە سەرکەوتوویی زیاد کرا!")
            st.rerun()
        else:
            st.error("تکایە نۆتەکە بنووسە!")
    
    st.markdown("---")
    
    # نمایشی نۆتەکان
    st.markdown("### 📋 نۆتەکانی پێشوو")
    
    if st.session_state.clinical_notes:
        # فلتەر بۆ نۆتەکان
        filter_type = st.radio("فلتر:", ["هەموو", "نەخۆشی", "دەرمان"], horizontal=True)
        
        filtered_notes = st.session_state.clinical_notes
        if filter_type == "نەخۆشی":
            filtered_notes = [n for n in filtered_notes if n.get("disease")]
        elif filter_type == "دەرمان":
            filtered_notes = [n for n in filtered_notes if n.get("drug")]
        
        # نمایشی نۆتەکان بە ڕیزبەندی کاتی
        ...
        st.info("هێشتا هیچ نۆتەیەک نەنووسراوە. یەکەم نۆتەکەت بنووسە!")
...
<div class="footer-style">
    ...
    <p>{get_disease_count()} نەخۆشی | {get_drug_count() + len(st.session_state.custom_drugs)} دەرمان | {get_quiz_count()} کویز | {len(LAB_TESTS) + len(st.session_state.custom_lab_tests)} پشکنین | {len(st.session_state.clinical_notes)} نۆتە</p>
    ...
    <p style="font-size:0.7rem;opacity:0.5;">پشکنین، دەرمان و نۆتە زیادکراوەکانت بە پارێزراوی لە فایلی JSON دا هەڵدەگیرێن</p>
</div>
""", unsafe_allow_html=True)
