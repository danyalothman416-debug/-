...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@300;400;500;600;700;800;900&family=Plus+Jakarta+Sans:wght@700;800&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            /* باکگراوندی کوالێتی بەرز و تاریک لە هەموو شاشەکە */
            background-image: 
                radial-gradient(circle at 15% 15%, rgba(191, 90, 242, 0.15), transparent 40%),
                radial-gradient(circle at 85% 85%, rgba(10, 132, 255, 0.15), transparent 45%),
                linear-gradient(rgba(7, 9, 14, 0.88), rgba(7, 9, 14, 0.94)),
        ...
        /* ١. پەڕەی سینەمایی بە ناوی "دانیال" و پڕبوونەوەی ١ تا ١٠٠ */
        #splashScreen {
            position: fixed;
        ...
        .danyal-brand-logo {
            ...
            font-size: 44px;
            color: #fff;
            box-shadow: 0 0 50px rgba(0, 112, 243, 0.8), inset 0 1px 1px rgba(255,255,255,0.4);
            animation: pulseGlow 2s infinite alternate ease-in-out;
        }

        @keyframes pulseGlow {
            0% { transform: scale(1); box-shadow: 0 0 35px rgba(121, 40, 202, 0.6); }
            100% { transform: scale(1.05); box-shadow: 0 0 60px rgba(0, 112, 243, 0.9); }
        }
        ...
        .progress-fill {
            height: 100%;
            width: 0%;
            background: linear-gradient(90deg, #7928ca, #0070f3, #00dfd8);
            border-radius: 20px;
...
<body>
    ...
    <!-- ١. دەستپێکی درەوشاوەی "دانیال" لەگەڵ لۆدەری خێرای ١٪ تا ١٠٠٪ -->
    <div id="splashScreen">
        <div class="splash-card">
            ...
            <div class="progress-percent" id="progressText">1%</div>
        </div>
    </div>

    <!-- ٢. پەڕەی چوونەژوورەوە بە ئیمەیڵی تایبەتی هەر کەسێک -->
    ...
    <script>
        ...
        // ئەنیمەیشنی خێرای ١٪ تا ١٠٠٪ لەسەر لۆگۆی "دانیال"
        ...
        async function submitEmailAuth() {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    errMsg.textContent = data.message || "هەڵەیەک ڕوویدا";
                    errMsg.style.display = 'block';
                }
            } catch(e) {
                errMsg.textContent = "پەیوەندی بە سێرڤەرەوە پچڕا";
                errMsg.style.display = 'block';
            }
        }
        ...
        function loginWithGooglePrompt() {
            const email = prompt("ئیمەیڵی گووگڵ بنووسە بۆ چوونەژوورەوە:");
