...
<body>
    ...
    <script>
        ...
        let splashTimer = setTimeout(finishSplash, 2500);
        ...
        async function saveNewDebt() {
            ...
            if (!amount || isNaN(amount) || Number(amount) <= 0) {
                alert("تکایە بڕی قەرز بە دروستی بنووسە!");
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    alert(data.message || "هەڵەیەک ڕوویدا لە کاتی پاشەکەوتکردن");
                }
            } catch (err) {
                alert("نەتوانرا پەیوەندی بە سێرڤەرەوە بکرێت");
            } finally {
                if (btn) {
                    btn.disabled = false;
